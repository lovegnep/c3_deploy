...
function x418100_ProcEventEntry( varMap, varPlayer, varBagIdx )
...
function x418100_ProcIsSpellLikeScript( varMap, varPlayer)
	return 1; 
end
...
function x418100_ProcCancelImpacts( varMap, varPlayer )
	return 0; 
end
...
function x418100_ProcConditionCheck( varMap, varPlayer )
...
function x418100_ProcDeplete( varMap, varPlayer )
	return 1;
end
...
function x418100_ProcActivateOnce( varMap, varPlayer, varImpact )
	if(DepletingUsedItem(varMap, varPlayer)) == 1 then
		SendSpecificImpactToUnit(varMap, varPlayer, varPlayer, varPlayer,8345, 0);

		
		x418100_ProcTopListYanghua(varMap,varPlayer)
...
function x418100_ProcActivateEachTick( varMap, varPlayer)
	return 1; 
end
...
function x418100_ProcTopListYanghua(varMap,varPlayer)
