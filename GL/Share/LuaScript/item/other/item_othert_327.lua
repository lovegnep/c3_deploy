x432327_var_FileId = 432327 


function x432327_ProcEventEntry( varMap, varPlayer, varBagIdx )

end

function x432327_ProcIsSpellLikeScript( varMap, varPlayer)
	return 1; 
	
	
end

function x432327_ProcCancelImpacts( varMap, varPlayer )
	return 0; 
end

function x432327_ProcConditionCheck( varMap, varPlayer )
...
function x432327_ProcDeplete( varMap, varPlayer )

	return 1
end

function x432327_ProcActivateOnce( varMap, varPlayer )
	...
	ItemAppendBind( varMap, 12500056, 1 ) --主手图谱·生命奖券1个
...
function x432327_ProcActivateEachTick( varMap, varPlayer)
	return 1; 
end
