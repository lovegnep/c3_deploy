...
function x418086_ProcEventEntry( varMap, varPlayer, varBagIdx )
...
function x418086_ProcIsSpellLikeScript( varMap, varPlayer)
	return 1; 
end
...
function x418086_ProcCancelImpacts( varMap, varPlayer )
	return 0; 
end
...
function x418086_ProcConditionCheck( varMap, varPlayer )
...
function x418086_ProcDeplete( varMap, varPlayer )
	return 1;
end
...
function x418086_ProcActivateOnce( varMap, varPlayer, varImpact )
	if(DepletingUsedItem(varMap, varPlayer)) == 1 then
		SendSpecificImpactToUnit(varMap, varPlayer, varPlayer, varPlayer,8331, 0);

		
		x418086_ProcTopListYanghua(varMap,varPlayer)
...
function x418086_ProcActivateEachTick( varMap, varPlayer)
	return 1; 
end
...
function x418086_ProcTopListYanghua(varMap,varPlayer)
