...
function x418082_ProcEventEntry( varMap, varPlayer, varBagIdx )
...
function x418082_ProcIsSpellLikeScript( varMap, varPlayer)
	return 1; 
end
...
function x418082_ProcCancelImpacts( varMap, varPlayer )
	return 0; 
end
...
function x418082_ProcConditionCheck( varMap, varPlayer )
...
function x418082_ProcDeplete( varMap, varPlayer )
	return 1;
end
...
function x418082_ProcActivateOnce( varMap, varPlayer, varImpact )
	if(DepletingUsedItem(varMap, varPlayer)) == 1 then
		SendSpecificImpactToUnit(varMap, varPlayer, varPlayer, varPlayer,8327, 0);

		
		x418082_ProcTopListYanghua(varMap,varPlayer)
...
function x418082_ProcActivateEachTick( varMap, varPlayer)
	return 1; 
end
...
function x418082_ProcTopListYanghua(varMap,varPlayer)
