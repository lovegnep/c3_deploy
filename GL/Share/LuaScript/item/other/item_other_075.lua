...
function x418075_ProcEventEntry( varMap, varPlayer, varBagIdx )
...
function x418075_ProcIsSpellLikeScript( varMap, varPlayer)
	return 1; 
end
...
function x418075_ProcCancelImpacts( varMap, varPlayer )
	return 0; 
end
...
function x418075_ProcConditionCheck( varMap, varPlayer )
...
function x418075_ProcDeplete( varMap, varPlayer )
	return 1;
end
...
function x418075_ProcActivateOnce( varMap, varPlayer, varImpact )
	if(DepletingUsedItem(varMap, varPlayer)) == 1 then
		SendSpecificImpactToUnit(varMap, varPlayer, varPlayer, varPlayer,8320, 0);
		
		
		x418075_ProcTopListYanghua(varMap,varPlayer)
...
function x418075_ProcActivateEachTick( varMap, varPlayer)
	return 1; 
end
...
function x418075_ProcTopListYanghua(varMap,varPlayer)
