...
function x418159_ProcEventEntry( varMap, varPlayer, varBagIdx )
...
function x418159_ProcIsSpellLikeScript( varMap, varPlayer)
	return 1; 
end
...
function x418159_ProcCancelImpacts( varMap, varPlayer )
	return 0; 
end
...
function x418159_ProcConditionCheck( varMap, varPlayer )
...
function x418159_ProcDeplete( varMap, varPlayer )
	return 1;
end
...
function x418159_ProcActivateOnce( varMap, varPlayer, varImpact )
	if(DepletingUsedItem(varMap, varPlayer)) == 1 then
		SendSpecificImpactToUnit(varMap, varPlayer, varPlayer, varPlayer,8358, 0);
		
		
		x418159_ProcTopListYanghua(varMap,varPlayer)
...
function x418159_ProcActivateEachTick( varMap, varPlayer)
	return 1; 
end
...
function x418159_ProcTopListYanghua(varMap,varPlayer)
