...
function x418158_ProcEventEntry( varMap, varPlayer, varBagIdx )
...
function x418158_ProcIsSpellLikeScript( varMap, varPlayer)
	return 1; 
end
...
function x418158_ProcCancelImpacts( varMap, varPlayer )
	return 0; 
end
...
function x418158_ProcConditionCheck( varMap, varPlayer )
...
function x418158_ProcDeplete( varMap, varPlayer )
	return 1;
end
...
function x418158_ProcActivateOnce( varMap, varPlayer, varImpact )
	if(DepletingUsedItem(varMap, varPlayer)) == 1 then
		SendSpecificImpactToUnit(varMap, varPlayer, varPlayer, varPlayer,8357, 0);
		
		
		x418158_ProcTopListYanghua(varMap,varPlayer)
...
function x418158_ProcActivateEachTick( varMap, varPlayer)
	return 1; 
end
...
function x418158_ProcTopListYanghua(varMap,varPlayer)
