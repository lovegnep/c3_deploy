...
x432123_var_FileId 		= 432123 

x432123_var_LevelMin		=	-1
--需要的等级
...
--事件交互入口
--**********************************
function x432123_ProcEventEntry( varMap, varPlayer, varBagIdx )
-- 不需要这个接口，但要保留空函数
end
...
--**********************************
function x432123_ProcIsSpellLikeScript( varMap, varPlayer)
	return 1; --这个脚本需要动作支持
end
...
--**********************************
function x432123_ProcCancelImpacts( varMap, varPlayer )
...
--**********************************
function x432123_ProcConditionCheck( varMap, varPlayer )
...
--给奖励
--**********************************
function x432123_GiveBonus( varMap,varPlayer)
...
--注：这里是技能生效一次的入口
--**********************************
function x432123_ProcActivateOnce( varMap, varPlayer, varImpact )
	...
	if curTimes <= 1 then
        -- delete item
        DelItemByIndexInBag( varMap, varPlayer, varBagIdx, 1)
    else
...
--注：这里是技能生效一次的入口
--**********************************
function x432123_ProcActivateEachTick( varMap, varPlayer)
	return 1; --不是引导性脚本, 只保留空函数.
end

function x432123_ProcDeplete( varMap, varPlayer)
	return 1
end
