...
function x418080_ProcEventEntry( varMap, varPlayer, varBagIdx )
...
function x418080_ProcIsSpellLikeScript( varMap, varPlayer)
	return 1; 
end
...
function x418080_ProcCancelImpacts( varMap, varPlayer )
	return 0; 
end
...
function x418080_ProcConditionCheck( varMap, varPlayer )
...
function x418080_ProcDeplete( varMap, varPlayer )
	return 1;
end
...
function x418080_ProcActivateOnce( varMap, varPlayer, varImpact )
	if(DepletingUsedItem(varMap, varPlayer)) == 1 then
		SendSpecificImpactToUnit(varMap, varPlayer, varPlayer, varPlayer,8325, 0);

		
		x418080_ProcTopListYanghua(varMap,varPlayer)
...
function x418080_ProcActivateEachTick( varMap, varPlayer)
	return 1; 
end
...
function x418080_ProcTopListYanghua(varMap,varPlayer)
