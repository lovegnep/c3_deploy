...
function x418078_ProcEventEntry( varMap, varPlayer, varBagIdx )
...
function x418078_ProcIsSpellLikeScript( varMap, varPlayer)
	return 1; 
end
...
function x418078_ProcCancelImpacts( varMap, varPlayer )
	return 0; 
end
...
function x418078_ProcConditionCheck( varMap, varPlayer )
...
function x418078_ProcDeplete( varMap, varPlayer )
	return 1;
end
...
function x418078_ProcActivateOnce( varMap, varPlayer, varImpact )
	if(DepletingUsedItem(varMap, varPlayer)) == 1 then
		SendSpecificImpactToUnit(varMap, varPlayer, varPlayer, varPlayer,8323, 0);

		
		x418078_ProcTopListYanghua(varMap,varPlayer)
...
function x418078_ProcActivateEachTick( varMap, varPlayer)
	return 1; 
end
...
function x418078_ProcTopListYanghua(varMap,varPlayer)
