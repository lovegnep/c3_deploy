...
function x418074_ProcEventEntry( varMap, varPlayer, varBagIdx )
...
function x418074_ProcIsSpellLikeScript( varMap, varPlayer)
	return 1; 
end
...
function x418074_ProcCancelImpacts( varMap, varPlayer )
	return 0; 
end
...
function x418074_ProcConditionCheck( varMap, varPlayer )
...
function x418074_ProcDeplete( varMap, varPlayer )
	return 1;
end
...
function x418074_ProcActivateOnce( varMap, varPlayer, varImpact )
	if(DepletingUsedItem(varMap, varPlayer)) == 1 then
		SendSpecificImpactToUnit(varMap, varPlayer, varPlayer, varPlayer,8319, 0);

		
		x418074_ProcTopListYanghua(varMap,varPlayer)
...
function x418074_ProcActivateEachTick( varMap, varPlayer)
	return 1; 
end
...
function x418074_ProcTopListYanghua(varMap,varPlayer)
