...
function x418102_ProcEventEntry( varMap, varPlayer, varBagIdx )
...
function x418102_ProcIsSpellLikeScript( varMap, varPlayer)
	return 1; 
end
...
function x418102_ProcCancelImpacts( varMap, varPlayer )
	return 0; 
end
...
function x418102_ProcConditionCheck( varMap, varPlayer )
...
function x418102_ProcDeplete( varMap, varPlayer )
	return 1;
end
...
function x418102_ProcActivateOnce( varMap, varPlayer, varImpact )
	if(DepletingUsedItem(varMap, varPlayer)) == 1 then
		SendSpecificImpactToUnit(varMap, varPlayer, varPlayer, varPlayer,8347, 0);

		
		x418102_ProcTopListYanghua(varMap,varPlayer)
...
function x418102_ProcActivateEachTick( varMap, varPlayer)
	return 1; 
end
...
function x418102_ProcTopListYanghua(varMap,varPlayer)
