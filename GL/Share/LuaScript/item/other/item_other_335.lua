x418335_var_FileId = 418335 


function x418335_ProcEventEntry( varMap, varPlayer, varBagIdx )

end

function x418335_ProcIsSpellLikeScript( varMap, varPlayer)
	return 1; 
	
	
end

function x418335_ProcCancelImpacts( varMap, varPlayer )
	return 0; 
end

function x418335_ProcConditionCheck( varMap, varPlayer )
...
function x418335_ProcDeplete( varMap, varPlayer )

	return 1
end

function x418335_ProcActivateOnce( varMap, varPlayer )
...
function x418335_ProcActivateEachTick( varMap, varPlayer)
	return 1; 
end
