...
x418649_var_FileId 		= 418649 

x418649_var_LevelMin		=	1

x418649_g_ItemID =12271324




function x418649_ProcEventEntry( varMap, varPlayer, varBagIdx )
	if GetItemIDByIndexInBag(varMap, varPlayer, varBagIdx) ~= x418649_g_ItemID then
		return
	end
     ...
     ItemAppendBind( varMap, itemid, 1 )	
	   ...
	   DeliverItemListSendToPlayer(varMap,varPlayer)	
		--GamePlayScriptLog( varMap, varPlayer, 3070+tempmark)
		 Msg2Player(varMap,varPlayer,format("您打开鸿运礼盒获得了@item_%d", itemid),4,3)
		end
	else
...
function x418649_ProcIsSpellLikeScript( varMap, varPlayer)
	return 0; 
end
...
function x418649_ProcCancelImpacts( varMap, varPlayer )
	return 0; 
end
...
function x418649_ProcConditionCheck( varMap, varPlayer )
...
function x418649_ProcDeplete( varMap, varPlayer )
...
function x418649_ProcActivateOnce( varMap, varPlayer, varImpact )
...
function x418649_ProcActivateEachTick( varMap, varPlayer)
	return 1; 
end
