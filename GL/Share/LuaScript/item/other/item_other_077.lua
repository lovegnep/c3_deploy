...
function x418077_ProcEventEntry( varMap, varPlayer, varBagIdx )
...
function x418077_ProcIsSpellLikeScript( varMap, varPlayer)
	return 1; 
end
...
function x418077_ProcCancelImpacts( varMap, varPlayer )
	return 0; 
end
...
function x418077_ProcConditionCheck( varMap, varPlayer )
...
function x418077_ProcDeplete( varMap, varPlayer )
	return 1;
end
...
function x418077_ProcActivateOnce( varMap, varPlayer, varImpact )
	if(DepletingUsedItem(varMap, varPlayer)) == 1 then
		SendSpecificImpactToUnit(varMap, varPlayer, varPlayer, varPlayer,8322, 0);

		
		x418077_ProcTopListYanghua(varMap,varPlayer)
...
function x418077_ProcActivateEachTick( varMap, varPlayer)
	return 1; 
end
...
function x418077_ProcTopListYanghua(varMap,varPlayer)
