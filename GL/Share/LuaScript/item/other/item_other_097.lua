...
function x418097_ProcEventEntry( varMap, varPlayer, varBagIdx )
...
function x418097_ProcIsSpellLikeScript( varMap, varPlayer)
	return 1; 
end
...
function x418097_ProcCancelImpacts( varMap, varPlayer )
	return 0; 
end
...
function x418097_ProcConditionCheck( varMap, varPlayer )
...
function x418097_ProcDeplete( varMap, varPlayer )
	return 1;
end
...
function x418097_ProcActivateOnce( varMap, varPlayer, varImpact )
	if(DepletingUsedItem(varMap, varPlayer)) == 1 then
		SendSpecificImpactToUnit(varMap, varPlayer, varPlayer, varPlayer,8342, 0);

		
		x418097_ProcTopListYanghua(varMap,varPlayer)
...
function x418097_ProcActivateEachTick( varMap, varPlayer)
	return 1; 
end
...
function x418097_ProcTopListYanghua(varMap,varPlayer)
