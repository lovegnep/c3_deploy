...
x418647_var_FileId 		= 418647 

x418647_var_LevelMin		=	1

x418647_g_ItemID =12271322




function x418647_ProcEventEntry( varMap, varPlayer, varBagIdx )
	if GetItemIDByIndexInBag(varMap, varPlayer, varBagIdx) ~= x418647_g_ItemID then
		return
	end
     ...
     ItemAppendBind( varMap, itemid, 1 )	
	   ...
	   DeliverItemListSendToPlayer(varMap,varPlayer)	
		--GamePlayScriptLog( varMap, varPlayer, 3070+tempmark)
		 Msg2Player(varMap,varPlayer,format("您打开喜运礼盒获得了@item_%d", itemid),4,3)
		end
	else
...
function x418647_ProcIsSpellLikeScript( varMap, varPlayer)
	return 0; 
end
...
function x418647_ProcCancelImpacts( varMap, varPlayer )
	return 0; 
end
...
function x418647_ProcConditionCheck( varMap, varPlayer )
...
function x418647_ProcDeplete( varMap, varPlayer )
...
function x418647_ProcActivateOnce( varMap, varPlayer, varImpact )
...
function x418647_ProcActivateEachTick( varMap, varPlayer)
	return 1; 
end
