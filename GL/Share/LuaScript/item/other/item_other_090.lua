...
function x418090_ProcEventEntry( varMap, varPlayer, varBagIdx )
...
function x418090_ProcIsSpellLikeScript( varMap, varPlayer)
	return 1; 
end
...
function x418090_ProcCancelImpacts( varMap, varPlayer )
	return 0; 
end
...
function x418090_ProcConditionCheck( varMap, varPlayer )
...
function x418090_ProcDeplete( varMap, varPlayer )
	return 1;
end
...
function x418090_ProcActivateOnce( varMap, varPlayer, varImpact )
	if(DepletingUsedItem(varMap, varPlayer)) == 1 then
		SendSpecificImpactToUnit(varMap, varPlayer, varPlayer, varPlayer,8335, 0);

		
		x418090_ProcTopListYanghua(varMap,varPlayer)
...
function x418090_ProcActivateEachTick( varMap, varPlayer)
	return 1; 
end
...
function x418090_ProcTopListYanghua(varMap,varPlayer)
