...
function x418084_ProcEventEntry( varMap, varPlayer, varBagIdx )
...
function x418084_ProcIsSpellLikeScript( varMap, varPlayer)
	return 1; 
end
...
function x418084_ProcCancelImpacts( varMap, varPlayer )
	return 0; 
end
...
function x418084_ProcConditionCheck( varMap, varPlayer )
...
function x418084_ProcDeplete( varMap, varPlayer )
	return 1;
end
...
function x418084_ProcActivateOnce( varMap, varPlayer, varImpact )
	if(DepletingUsedItem(varMap, varPlayer)) == 1 then
		SendSpecificImpactToUnit(varMap, varPlayer, varPlayer, varPlayer,8329, 0);

		
		x418084_ProcTopListYanghua(varMap,varPlayer)
...
function x418084_ProcActivateEachTick( varMap, varPlayer)
	return 1; 
end
...
function x418084_ProcTopListYanghua(varMap,varPlayer)
