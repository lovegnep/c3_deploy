...
function x418081_ProcEventEntry( varMap, varPlayer, varBagIdx )
...
function x418081_ProcIsSpellLikeScript( varMap, varPlayer)
	return 1; 
end
...
function x418081_ProcCancelImpacts( varMap, varPlayer )
	return 0; 
end
...
function x418081_ProcConditionCheck( varMap, varPlayer )
...
function x418081_ProcDeplete( varMap, varPlayer )
	return 1;
end
...
function x418081_ProcActivateOnce( varMap, varPlayer, varImpact )
	if(DepletingUsedItem(varMap, varPlayer)) == 1 then
		SendSpecificImpactToUnit(varMap, varPlayer, varPlayer, varPlayer,8326, 0);

		
		x418081_ProcTopListYanghua(varMap,varPlayer)
...
function x418081_ProcActivateEachTick( varMap, varPlayer)
	return 1; 
end
...
function x418081_ProcTopListYanghua(varMap,varPlayer)
