...
function x418089_ProcEventEntry( varMap, varPlayer, varBagIdx )
...
function x418089_ProcIsSpellLikeScript( varMap, varPlayer)
	return 1; 
end
...
function x418089_ProcCancelImpacts( varMap, varPlayer )
	return 0; 
end
...
function x418089_ProcConditionCheck( varMap, varPlayer )
...
function x418089_ProcDeplete( varMap, varPlayer )
	return 1;
end
...
function x418089_ProcActivateOnce( varMap, varPlayer, varImpact )
	if(DepletingUsedItem(varMap, varPlayer)) == 1 then
		SendSpecificImpactToUnit(varMap, varPlayer, varPlayer, varPlayer,8334, 0);

		
		x418089_ProcTopListYanghua(varMap,varPlayer)
...
function x418089_ProcActivateEachTick( varMap, varPlayer)
	return 1; 
end
...
function x418089_ProcTopListYanghua(varMap,varPlayer)
