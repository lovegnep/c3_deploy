...
x418062_var_FileId = 418062
x418062_var_ItemList = {}
x418062_var_LevelMin = 60
...
function x418062_ProcEventEntry( varMap, varPlayer, varBagIdx )
...
function x418062_ProcIsSpellLikeScript( varMap, varPlayer)
	return 1; 
end
...
function x418062_ProcCancelImpacts( varMap, varPlayer )
	return 0; 
end
...
function x418062_ProcConditionCheck( varMap, varPlayer )
...
function x418062_ProcDeplete( varMap, varPlayer )
...
function x418062_ProcActivateOnce( varMap, varPlayer, varImpact )
	
	if GetLevel(varMap, varPlayer)< x418062_var_LevelMin then
...
function x418062_ProcActivateEachTick( varMap, varPlayer)
	return 1; 
end
