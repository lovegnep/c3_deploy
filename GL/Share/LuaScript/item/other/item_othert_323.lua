x432323_var_FileId = 432323 


function x432323_ProcEventEntry( varMap, varPlayer, varBagIdx )

end

function x432323_ProcIsSpellLikeScript( varMap, varPlayer)
	return 1; 
	
	
end

function x432323_ProcCancelImpacts( varMap, varPlayer )
	return 0; 
end

function x432323_ProcConditionCheck( varMap, varPlayer )
...
function x432323_ProcDeplete( varMap, varPlayer )

	return 1
end

function x432323_ProcActivateOnce( varMap, varPlayer )
...
function x432323_ProcActivateEachTick( varMap, varPlayer)
	return 1; 
end
