...
x430114_var_FileId 		= 430114 


x430114_var_LevelMin		= 100
x430114_var_LevelMax		= 161

x430114_var_Exp           = 2000000




function x430114_ProcEventEntry( varMap, varPlayer, varBagIdx)
...
function x430114_ProcIsSpellLikeScript( varMap, varPlayer)
	return 1; 
end
...
function x430114_ProcCancelImpacts( varMap, varPlayer)
	return 0; 
end
...
function x430114_ProcConditionCheck( varMap, varPlayer)
	
	if( 1~=VerifyUsedItem( varMap, varPlayer) ) then
		return 0
	end
    local varLevel = GetLevel( varMap, varPlayer)
    if varLevel < x430114_var_LevelMin then
        Msg2Player( varMap, varPlayer, "你的等级低于使用此物品的最低级别", 8, 3)
        return 0
    end
    if varLevel >= x430114_var_LevelMax then
...
function x430114_ProcDeplete( varMap, varPlayer)
...
function x430114_ProcActivateOnce( varMap, varPlayer, varImpact)
    ...
    AddExp( varMap, varPlayer, x430114_var_Exp)
...
function x430114_ProcActivateEachTick( varMap, varPlayer)
	return 1; 
end
