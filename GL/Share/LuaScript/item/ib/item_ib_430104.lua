...
x430104_var_FileId 		= 430104 


x430104_var_LevelMin		= 50
x430104_var_LevelMax		= 60

x430104_var_Exp           = 550000




function x430104_ProcEventEntry( varMap, varPlayer, varBagIdx)
...
function x430104_ProcIsSpellLikeScript( varMap, varPlayer)
	return 1; 
end
...
function x430104_ProcCancelImpacts( varMap, varPlayer)
	return 0; 
end
...
function x430104_ProcConditionCheck( varMap, varPlayer)
	
	if( 1~=VerifyUsedItem( varMap, varPlayer) ) then
		return 0
	end
    local varLevel = GetLevel( varMap, varPlayer)
    if varLevel < x430104_var_LevelMin then
        Msg2Player( varMap, varPlayer, "你的等级低于使用此物品的最低级别", 8, 3)
        return 0
    end
    if varLevel >= x430104_var_LevelMax then
...
function x430104_ProcDeplete( varMap, varPlayer)
...
function x430104_ProcActivateOnce( varMap, varPlayer, varImpact)
    ...
    AddExp( varMap, varPlayer, x430104_var_Exp)
...
function x430104_ProcActivateEachTick( varMap, varPlayer)
	return 1; 
end
