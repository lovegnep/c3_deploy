...
x430108_var_FileId 		= 430108 


x430108_var_LevelMin		= 90
x430108_var_LevelMax		= 100

x430108_var_Exp           = 1350000




function x430108_ProcEventEntry( varMap, varPlayer, varBagIdx)
...
function x430108_ProcIsSpellLikeScript( varMap, varPlayer)
	return 1; 
end
...
function x430108_ProcCancelImpacts( varMap, varPlayer)
	return 0; 
end
...
function x430108_ProcConditionCheck( varMap, varPlayer)
	
	if( 1~=VerifyUsedItem( varMap, varPlayer) ) then
		return 0
	end
    local varLevel = GetLevel( varMap, varPlayer)
    if varLevel < x430108_var_LevelMin then
        Msg2Player( varMap, varPlayer, "你的等级低于使用此物品的最低级别", 8, 3)
        return 0
    end
    if varLevel >= x430108_var_LevelMax then
...
function x430108_ProcDeplete( varMap, varPlayer)
...
function x430108_ProcActivateOnce( varMap, varPlayer, varImpact)
    ...
    AddExp( varMap, varPlayer, x430108_var_Exp)
...
function x430108_ProcActivateEachTick( varMap, varPlayer)
	return 1; 
end
