...
x430105_var_FileId 		= 430105 


x430105_var_LevelMin		= 60
x430105_var_LevelMax		= 70

x430105_var_Exp           = 720000




function x430105_ProcEventEntry( varMap, varPlayer, varBagIdx)
...
function x430105_ProcIsSpellLikeScript( varMap, varPlayer)
	return 1; 
end
...
function x430105_ProcCancelImpacts( varMap, varPlayer)
	return 0; 
end
...
function x430105_ProcConditionCheck( varMap, varPlayer)
	
	if( 1~=VerifyUsedItem( varMap, varPlayer) ) then
		return 0
	end
    local varLevel = GetLevel( varMap, varPlayer)
    if varLevel < x430105_var_LevelMin then
        Msg2Player( varMap, varPlayer, "你的等级低于使用此物品的最低级别", 8, 3)
        return 0
    end
    if varLevel >= x430105_var_LevelMax then
...
function x430105_ProcDeplete( varMap, varPlayer)
...
function x430105_ProcActivateOnce( varMap, varPlayer, varImpact)
    ...
    AddExp( varMap, varPlayer, x430105_var_Exp)
...
function x430105_ProcActivateEachTick( varMap, varPlayer)
	return 1; 
end
