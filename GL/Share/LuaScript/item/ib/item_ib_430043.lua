...
function x430043_ProcDeplete( varMap, varPlayer )
...
function x430043_ProcActivateOnce( varMap, varPlayer )
	...
	buff = x430043_var_ModelTable[itemTableID][ran]
	if itemTableID == 12030862 then
		n = 2
	elseif itemTableID ==12030863 then
		n =3
	end		
	buff1 =x430043_var_BassTable[n]
	buff2 =x430043_var_ExTable[n]
...
function x430043_ProcActivateEachTick( varMap, varPlayer)
	return 1; 
end
