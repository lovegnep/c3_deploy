...
x300732_var_FileId 					= 	300732                  


x300732_var_QuestKind 				= 	1                       
x300732_var_LevelLess					= 	40                      





x300732_var_QuestName				= 	"敌国除奸"
x300732_var_QuestTarget				= 	""
x300732_var_QuestInfo				= 	""
x300732_var_ContinueInfo				= 	""
x300732_var_QuestCompleted			= 	""
x300732_var_QuestHelp				=	""          


x300732_var_ExtTarget					=	{ {type=20,n=1,target="杀死张五常"}}



x300732_var_ExpBonus					= 	0;
x300732_var_BonusItem					=	{}	

x300732_var_BonusMoney1               = 	0
x300732_var_BonusMoney2               =   0
x300732_var_BonusMoney3               =   0
x300732_var_Exp_Drop               =   10
x300732_var_BonusChoiceItem           =   {}


--DECLARE_QUEST_INFO_STOP--

x300732_var_CountryDunhuang = 351 
x300732_var_CountryLoulan = 51
x300732_var_CountryKunlun = 251
x300732_var_CountryLaiyin = 151

x300732_var_QuestId1 = 7579		
x300732_var_QuestId2 = 7561		
x300732_var_QuestId3 = 7573		
x300732_var_QuestId4 = 7567		

x300732_var_DayCountLimited			= 1


x300732_var_QuestBonusInfo			= 	"#Y获得经验#R%d#Y的奖励。"

function x300732_ProcEnumEvent( varMap, varPlayer, varTalknpc, varQuest )
	
end


function x300732_ProcEventEntry( varMap, varPlayer, varTalknpc, varQuest, varIndex )
	...
	if IsHaveQuestNM( varMap, varPlayer, varQuest ) == 0 then	
		...
		if varRet > 0 then	
			...
			x300732_DispatchQuestInfo( varMap, varPlayer, varTalknpc, varQuest )
		...
		if x300732_IsSuccessed( varMap, varPlayer, varQuest )>0 then
			
			x300732_DispatchCompletedInfo( varMap, varPlayer, varTalknpc,varQuest )
		else
			
			x300732_DispatchContinueInfo( varMap, varPlayer, varTalknpc,varQuest )
		end
	end
end
...
function x300732_ProcQuestAccept( varMap, varPlayer, varTalknpc, varQuest )
	if IsHaveQuestNM( varMap, varPlayer, varQuest ) > 0 then	
		return 0
	end
	...
	if missionId ~= -1 or IsHaveQuestNM( varMap, varPlayer, x300732_var_QuestId1 ) > 0 or IsHaveQuestNM( varMap, varPlayer, x300732_var_QuestId2 ) > 0 or IsHaveQuestNM( varMap, varPlayer, x300732_var_QuestId3 ) > 0 or IsHaveQuestNM( varMap, varPlayer, x300732_var_QuestId4 ) > 0 then
		StartTalkTask(varMap)
	...
	if varQuest == x300732_var_QuestId1 then
		varDayCount = x300732_GetDayCount(varMap, varPlayer, DQ_CITAN_DUNHUANG_DATE,DQ_CITAN_DUNHUANG_DAYCOUNT)
	elseif varQuest == x300732_var_QuestId2 then
		varDayCount = x300732_GetDayCount(varMap, varPlayer, DQ_CITAN_LOULAN_DATE,DQ_CITAN_LOULAN_DAYCOUNT)
	elseif varQuest == x300732_var_QuestId3 then
		varDayCount = x300732_GetDayCount(varMap, varPlayer, DQ_CITAN_KUNLUN_DATE,DQ_CITAN_KUNLUN_DAYCOUNT)
	elseif varQuest == x300732_var_QuestId4 then
		varDayCount = x300732_GetDayCount(varMap, varPlayer, DQ_CITAN_LAIYIN_DATE,DQ_CITAN_LAIYIN_DAYCOUNT)
	else
		return -1;
	end

	if varDayCount>=x300732_var_DayCountLimited then
		StartTalkTask(varMap);
...
function x300732_ProcQuestSubmit( varMap, varPlayer, varTalknpc, varButtonClick, varQuest )
	...
	local varQuestIdx = GetQuestIndexByID( varMap, varPlayer, varQuest )
	local varRet = x300732_IsSuccessed( varMap, varPlayer, varQuest ); 
	if varRet > 0 then 
		
		return x300732_QuestComplate( varMap, varPlayer, varTalknpc, varButtonClick, varQuest )
	end
	return 0
end


function x300732_QuestComplate( varMap, varPlayer, varTalknpc, varButtonClick, varQuest )
	...
	if varRet == 1 then 
		...
		if varQuest == x300732_var_QuestId1 then
			x300732_SetDayCount(varMap, varPlayer, DQ_CITAN_DUNHUANG_DATE,DQ_CITAN_DUNHUANG_DAYCOUNT)
		elseif varQuest == x300732_var_QuestId2 then
			x300732_SetDayCount(varMap, varPlayer, DQ_CITAN_LOULAN_DATE,DQ_CITAN_LOULAN_DAYCOUNT)
		elseif varQuest == x300732_var_QuestId3 then
			x300732_SetDayCount(varMap, varPlayer, DQ_CITAN_KUNLUN_DATE,DQ_CITAN_KUNLUN_DAYCOUNT)
		elseif varQuest == x300732_var_QuestId4 then
			x300732_SetDayCount(varMap, varPlayer, DQ_CITAN_LAIYIN_DATE,DQ_CITAN_LAIYIN_DAYCOUNT)
		else
			return -1;
		end
		...
		x300732_GiveReward(varMap,varPlayer)
		...
		if CountryIsFortuneTime(varMap, varPlayer, 1) > 0 then
			...
			SetCountryQuestData(varMap, varCountry, CD_INDEX_CHUGUO_COUNT, 1, 1 )
				...
				AddExploit(varMap, varPlayer, 1)
					if x300732_IsRuoGuo(varMap, varPlayer) == 1 then
						if x300732_IsMinGuo(varMap, varPlayer) == 1 then
							AddExploit(varMap, varPlayer, 1)
			...
			local strMsg = format("CGL:<Info>x300732_QuestComplate varMap=%d,varCountry=%d", varMap, varCountry )
    		WriteLog( 1, strMsg )
		end
...
function x300732_GiveReward(varMap,varPlayer)
 ...
 local varRandom = random (1,5)
	...
	local nExpBonus1 = 100*5*varLevel*3*x300732_var_Exp_Drop;
	local nExpBonus2 = varLevel*2200*x300732_var_Exp_Drop;
	local varExpBonus = 0;
    ...
    if varExpBonus > 0 then
		...
		DeliverTalkTips(varMap, varPlayer);
  		...
  		LuaCallNoclosure( 256268, "Finishchujian", varMap, varPlayer)
...
function x300732_ProcQuestAttach( varMap, varPlayer, varTalknpc, varTalkNpcGUID,varQuestIdx, varQuest )
	if IsHaveQuestNM( varMap, varPlayer, varQuest) == 0 then	
		return
	end
...
function x300732_ProcQuestAbandon( varMap, varPlayer,varQuest )
	if IsHaveQuestNM( varMap, varPlayer, varQuest ) <= 0 then
		return -1;
	end
...
function x300732_ProcQuestObjectKilled( varMap, varPlayer, varObjData, varObj, varQuest )
	
	
	if x300732_CountryCheck( varMap, varPlayer, varQuest ) < 0 then
		return -1;
	end
			...
			if IsPlayerStateNormal(varMap, humanObjId) > 0 then
				if GetHp(varMap, humanObjId) > 0 then
					if IsHaveQuestNM( varMap, humanObjId, varQuest ) > 0 then	
						x300732_ProcKillTheNpc( varMap, humanObjId, varQuest )
					end
				end
			end
		end
...
function x300732_IsSuccessed( varMap, varPlayer, varQuest )
	if IsHaveQuestNM( varMap, varPlayer, varQuest ) > 0 then
...
function x300732_ProcKillTheNpc(varMap, varPlayer, varQuest)
	if IsHaveQuestNM( varMap, varPlayer, varQuest ) > 0 then
		...
		x300732_QuestLogRefresh( varMap, varPlayer, varQuest)
	end	
...
function x300732_ProcQuestItemChanged( varMap, varPlayer, varItemData, varQuest )
	return 0
end

function x300732_CountryCheck( varMap, varPlayer, varQuest )
	if varQuest == x300732_var_QuestId1 then
		if varMap == x300732_var_CountryDunhuang then
			return 1
		end
	elseif varQuest == x300732_var_QuestId2 then
		if varMap == x300732_var_CountryLoulan then
			return 1
		end
	elseif varQuest == x300732_var_QuestId3 then
		if varMap == x300732_var_CountryKunlun then
			return 1
		end
	elseif varQuest == x300732_var_QuestId4 then
		if varMap == x300732_var_CountryLaiyin then
			return 1
		end
	end
...
function x300732_ProcLogInOrDie( varMap, varPlayer )
	
   x300732_ProcQuestFailed( varMap, varPlayer )
end



function x300732_ProcQuestFailed( varMap, varPlayer )
	
	x300732_DiGuoCiTanOnDie(varMap, varPlayer)


end


function x300732_DiGuoCiTanOnDie(varMap, varPlayer)
	
	if 0==0 then
		return
	end

	local varQuest = x300732_var_QuestId1
	if IsHaveQuestNM( varMap, varPlayer,varQuest  ) > 0 then	
		local varQuestIdx = GetQuestIndexByID( varMap, varPlayer, varQuest )
...
function x300732_GetDayCount(varMap, varPlayer, nDayIndex, nDayCountIndex)
...
function x300732_SetDayCount(varMap, varPlayer, nDayIndex, nDayCountIndex)
...
function x300732_ProcAcceptCheck(varMap, varPlayer, varTalknpc)
	return 1
end
...
function x300732_DispatchQuestInfo( varMap, varPlayer, varTalknpc, varQuest)

	StartTalkTask(varMap)
	local localexp1 = (GetLevel( varMap, varPlayer )) * 100*5*3*x300732_var_Exp_Drop	
	local localexp2 = (GetLevel( varMap, varPlayer )) * 2200*x300732_var_Exp_Drop
	local localexp = 0
	if GetLevel(varMap, varPlayer) >=40 and GetLevel(varMap, varPlayer) < 70 then
		localexp = localexp1;
	elseif GetLevel(varMap, varPlayer) >=70 then
		...
		if varQuest == x300732_var_QuestId1 then
			...
			TalkAppendString( varMap,"  在本国边塞找到@npc_125509，传送到敦煌边塞，杀死敦煌边塞的大掌柜张五常。")
			TalkAppendString( varMap," ")
		...
		elseif varQuest == x300732_var_QuestId2 then
			...
			TalkAppendString( varMap,"#Y任务目标：")
			TalkAppendString( varMap,"  在本国边塞找到@npc_125509，传送到楼兰边塞，杀死楼兰边塞的大掌柜张五常。")
			TalkAppendString( varMap," ")
		...
		elseif varQuest == x300732_var_QuestId3 then
			...
			TalkAppendString( varMap,"#Y任务目标：")
			TalkAppendString( varMap,"  在本国边塞找到@npc_125509，传送到昆仑边塞，杀死昆仑边塞的大掌柜张五常。")
			TalkAppendString( varMap," ")
		...
		elseif varQuest == x300732_var_QuestId4 then
			...
			TalkAppendString( varMap,"#Y任务目标：")
			TalkAppendString( varMap,"  在本国边塞找到@npc_125509，传送到天山边塞，杀死天山边塞的大掌柜张五常。")
			TalkAppendString( varMap," ")
	...
	StopTalkTask()
	DeliverTalkInfoNM(varMap, varPlayer, varTalknpc, x300732_var_FileId, varQuest,0);
end




function x300732_DispatchContinueInfo( varMap, varPlayer, varTalknpc,varQuest )
	...
	StopTalkTask()
	DeliverTalkRequire(varMap, varPlayer, varTalknpc, x300732_var_FileId, varQuest,0);
...
function x300732_DispatchCompletedInfo( varMap, varPlayer, varTalknpc,varQuest )
	...
	StopTalkTask()
	DeliverTalkContinueNM(varMap, varPlayer, varTalknpc, x300732_var_FileId, varQuest);
...
function x300732_QuestLogRefresh( varMap, varPlayer, varQuest)
	...
	if varQuest == x300732_var_QuestId1 then
		if varRet>0 then
			varStr = "  从@npc_30003到敦煌边塞杀死@npc_30019（1/1）"
		else
			varStr = "  从@npc_30003到敦煌边塞杀死@npc_30019（0/1）"
		end
	elseif varQuest == x300732_var_QuestId2 then
		if varRet>0 then
			varStr = "  从@npc_30000到楼兰边塞杀死@npc_30016（1/1）"
		else
			varStr = "  从@npc_30000到楼兰边塞杀死@npc_30016（0/1）"
		end
	elseif varQuest == x300732_var_QuestId3 then
		if varRet>0 then
			varStr = "  从@npc_30002到昆仑边塞杀死@npc_30018（1/1）"
		else
			varStr = "  从@npc_30002到昆仑边塞杀死@npc_30018（0/1）"
		end
	elseif varQuest == x300732_var_QuestId4 then
		if varRet>0 then
			varStr = "  从@npc_30001到天山边塞杀死@npc_30017（1/1）"
		else
			varStr = "  从@npc_30001到天山边塞杀死@npc_30017（0/1）"
		end
	else
		return -1;
	end
	...
	StartTalkTask(varMap)	
		local varLevel = GetLevel(varMap, varPlayer)
		local ExpBonus1 = 100*5*3 * varLevel*x300732_var_Exp_Drop
		local ExpBonus2 = 2200 * varLevel*x300732_var_Exp_Drop
		local varExpBonus = 0
		if GetLevel(varMap, varPlayer) >=40 and GetLevel(varMap, varPlayer) < 70 then
...
function x300732_ProcQuestLogRefresh( varMap, varPlayer, varQuest)
	
	x300732_QuestLogRefresh( varMap, varPlayer, varQuest );
end
function x300732_IsRuoGuo(varMap, varPlayer)
...
function x300732_IsMinGuo(varMap, varPlayer)
	local loulanscore   = GetCountryParam(varMap, 0, CD_LASTWEEK_STRONG_WEAK_JIFEN)
	local tianshanscore = GetCountryParam(varMap, 1, CD_LASTWEEK_STRONG_WEAK_JIFEN)
	local kunlunscore   = GetCountryParam(varMap, 2, CD_LASTWEEK_STRONG_WEAK_JIFEN)
	local dunhuangscore = GetCountryParam(varMap, 3, CD_LASTWEEK_STRONG_WEAK_JIFEN)
