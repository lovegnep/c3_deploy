...
-- 兑换目标道具名称
x350014_var_TargetName = "#R四彩护身符"
-- 兑换目标道具ID
x350014_var_ExcObjID = {
{index = 1 ,targetID = 10340035, targetName = "护身符：四彩护身符·圣战神"},
{index = 2 ,targetID = 10340036, targetName = "护身符：四彩护身符·圣剑魔"},
{index = 3 ,targetID = 10340037, targetName = "护身符：四彩护身符·圣追风"},
{index = 4 ,targetID = 10340038, targetName = "护身符：四彩护身符·圣灭神"},
{index = 5 ,targetID = 10340039, targetName = "护身符：四彩护身符·圣狂魔"},
{index = 6 ,targetID = 10340040, targetName = "护身符：四彩护身符·圣医仙"},
}
-- 兑换道具名称
...
x350014_var_QuestName = "#R【圣系列护身符】%s"
x350014_var_Questintro = "\t你可以用四彩护身符碎片在我处兑换四彩护身符·圣战神、四彩护身符·圣剑魔、四彩护身符·圣追风、四彩护身符·圣灭神、四彩护身符·圣狂魔和四彩护身符·圣医仙，500个暗影四彩护身符碎片就可以兑换一个传奇护身符。"
	...
	if seleteId == -1 then
		StartTalkTask(varMap)
			...
			for varI, item in x350014_var_ExcObjID  do
				TalkAppendButton( varMap, x350014_var_FileId, "【兑换】兑换"..item.targetName, 3, varI )
			end
		StopTalkTask()
