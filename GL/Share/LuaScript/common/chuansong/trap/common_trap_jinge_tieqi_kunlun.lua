...
x300468_var_FileId = 300468
x300468_var_TransPosloulan=		"jinge2tieqiloulan"
x300468_var_TransPoslaiyin=		"jinge2tieqilanyin"
x300468_var_TransPoskunlun=		"jinge2tieqikunlun"
x300468_var_TransPosdunhuang=	"jinge2tieqidunhuang"



function x300468_ProcAreaEntered( varMap, varPlayer, varArea, varQuest )
	...
	if selfType == 9 then	
		...
		if busType == 1 then 
			...
			for	varI = 0, memberCount - 1 do
				...
				x300468_TransToPosition(varMap, varObj)
			end
	...
	x300468_TransToPosition(varMap, varPlayer)
	
end

function x300468_TransToPosition(varMap, varPlayer)
	local varCountry = GetCurCountry(varMap,varPlayer)
	if varCountry == 2 then
		LuaCallNoclosure(COMMON_CHUANSONG_NORMAL, "TransferToWorld",varMap,varPlayer,x300468_var_TransPoskunlun)
	else
		StartTalkTask(varMap)
...
function x300468_ProcMapTimerTick( varMap, monsterobjid )

end


function x300468_ProcAreaLeaved( varMap, monsterobjid, varScript, varQuest )

end


function x300468_ProcEventEntry( varMap, monsterobjid )
