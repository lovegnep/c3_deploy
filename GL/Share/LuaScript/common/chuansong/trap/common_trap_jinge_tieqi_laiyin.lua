...
x300467_var_FileId = 300467
x300467_var_TransPosloulan=		"jinge2tieqiloulan"
x300467_var_TransPoslaiyin=		"jinge2tieqilanyin"
x300467_var_TransPoskunlun=		"jinge2tieqikunlun"
x300467_var_TransPosdunhuang=	"jinge2tieqidunhuang"



function x300467_ProcAreaEntered( varMap, varPlayer, varArea, varQuest )
	...
	if selfType == 9 then	
		...
		if busType == 1 then 
			...
			for	varI = 0, memberCount - 1 do
				...
				x300467_TransToPosition(varMap, varObj)
			end
	...
	x300467_TransToPosition(varMap, varPlayer)
	
end

function x300467_TransToPosition(varMap, varPlayer)
	local varCountry = GetCurCountry(varMap,varPlayer)
	if varCountry == 1 then
		LuaCallNoclosure(COMMON_CHUANSONG_NORMAL, "TransferToWorld",varMap,varPlayer,x300467_var_TransPoslaiyin)
	else
		StartTalkTask(varMap)
...
function x300467_ProcMapTimerTick( varMap, monsterobjid )

end


function x300467_ProcAreaLeaved( varMap, monsterobjid, varScript, varQuest )

end


function x300467_ProcEventEntry( varMap, monsterobjid )
