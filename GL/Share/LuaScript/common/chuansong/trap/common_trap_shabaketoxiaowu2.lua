...
x490452_var_FileId = 490452
x490452_var_TransPosloulan  ="shabaketominju2"
x490452_var_TransPoslaiyin  ="shabaketominju2"
x490452_var_TransPoskunlun  ="shabaketominju2"
x490452_var_TransPosdunhuang="shabaketominju2"


function x490452_ProcAreaEntered( varMap, varPlayer, varArea, varQuest )
	...
	if selfType == 9 then	
		...
		if busType == 1 then 
			...
			for	varI = 0, memberCount - 1 do
				...
				x490452_TransToPosition(varMap, varObj)
			end
	...
	x490452_TransToPosition(varMap, varPlayer)
end

function x490452_TransToPosition(varMap, varPlayer)

	local guo = GetCurCountry(varMap,varPlayer)
	
	if guo == 0 then
		LuaCallNoclosure(COMMON_CHUANSONG_NORMAL, "TransferToWorld",varMap,varPlayer,x490452_var_TransPosloulan)
		
		elseif guo == 1 then
		LuaCallNoclosure(COMMON_CHUANSONG_NORMAL, "TransferToWorld",varMap,varPlayer,x490452_var_TransPoslaiyin)
		
		elseif guo == 2 then
		LuaCallNoclosure(COMMON_CHUANSONG_NORMAL, "TransferToWorld",varMap,varPlayer,x490452_var_TransPoskunlun)
		
		elseif guo == 3 then
		LuaCallNoclosure(COMMON_CHUANSONG_NORMAL, "TransferToWorld",varMap,varPlayer,x490452_var_TransPosdunhuang)
	
	end
end


function x490452_ProcMapTimerTick( varMap, monsterobjid )

end


function x490452_ProcAreaLeaved( varMap, monsterobjid, varScript, varQuest )

end


function x490452_ProcEventEntry( varMap, monsterobjid )
