...
x300433_var_FileId = 300433
x300433_var_TransPosloulan  ="gudao2wangchengloulan"
x300433_var_TransPoslaiyin  ="gudao2wangchengloulan"
x300433_var_TransPoskunlun  ="gudao2wangchengloulan"
x300433_var_TransPosdunhuang="gudao2wangchengloulan"



function x300433_ProcAreaEntered( varMap, varPlayer, varArea, varQuest )
	...
	if selfType == 9 then	
		...
		if busType == 1 then 
			...
			for	varI = 0, memberCount - 1 do
				...
				x300433_TransToPosition(varMap, varObj)
			end
	...
	x300433_TransToPosition(varMap, varPlayer)
end

function x300433_TransToPosition(varMap, varPlayer)

	local guo = GetCurCountry(varMap,varPlayer)
	
	if guo == 0 then
		LuaCallNoclosure(COMMON_CHUANSONG_NORMAL, "TransferToWorld",varMap,varPlayer,x300433_var_TransPosloulan)
		
		elseif guo == 1 then
		LuaCallNoclosure(COMMON_CHUANSONG_NORMAL, "TransferToWorld",varMap,varPlayer,x300433_var_TransPoslaiyin)
		
		elseif guo == 2 then
		LuaCallNoclosure(COMMON_CHUANSONG_NORMAL, "TransferToWorld",varMap,varPlayer,x300433_var_TransPoskunlun)
		
		elseif guo == 3 then
		LuaCallNoclosure(COMMON_CHUANSONG_NORMAL, "TransferToWorld",varMap,varPlayer,x300433_var_TransPosdunhuang)
	
	end
end


function x300433_ProcMapTimerTick( varMap, monsterobjid )

end


function x300433_ProcAreaLeaved( varMap, monsterobjid, varScript, varQuest )

end


function x300433_ProcEventEntry( varMap, monsterobjid )
