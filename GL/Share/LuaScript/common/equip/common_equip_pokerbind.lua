...
x800144_var_CostTable = {
                            { itemid=11970018, itemname="浮世印", probability1=0,   probability2=100,   needmoney=10000 },
...
x800144_var_PokerCardNumTable =    {
                                    ...
                                    { value = 5, probability = 0 },
                                    { value = 6, probability = 0 },
                                    { value = 7, probability = 0 },
                                    { value = 8, probability = 0 },
                                    { value = 9, probability = 0 },
                                    { value = 10, probability = 0 },
                                    { value = 11, probability = 0 },
                                    { value = 12, probability = 0 },
                                    { value = 13, probability = 10 },
