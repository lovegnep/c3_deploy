...
-- 兑换道具需要数量
x570095_var_ExcItemNum = 300

x570095_var_QuestName = "#R【兑换掌门牌】%s"
x570095_var_QuestName1 = "【新版掌门牌说明】"
x570095_var_Questintro = "\t你可以用珍贵的龙之谷晶石在我这里兑换新版的#G永不磨损#W的掌门牌，300个龙之谷晶石就可以兑换任意一个新版掌门牌。"
x570095_var_Questintro1 ="\n\t#G你可以用珍贵的#G龙之谷晶石#W在我处兑换#G圣·青龙腾空(永不磨损)、圣·白虎啸风(永不磨损)、圣·朱雀焚天(永不磨损)、圣·玄武震月(永不磨损)、圣·麒麟灭日(永不磨损)。"
