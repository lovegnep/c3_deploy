...
-- 兑换目标道具名称
x570103_var_TargetName = "稀世异宝"

-- 兑换目标道具ID
x570103_var_ExcObjID = {
{index = 1 ,targetID = 12050431, targetName = "稀世异宝兑换近攻型成年神马（流星火雨）降世符"},
{index = 2 ,targetID = 12050432, targetName = "稀世异宝兑换远攻型成年神马（流星火雨）降世符"},
{index = 3 ,targetID = 12050433, targetName = "稀世异宝兑换魔攻型成年神马（流星火雨）降世符"},
{index = 4 ,targetID = 10306148, targetName = "稀世异宝兑换决战八方（永久）"},
{index = 5 ,targetID = 10306149, targetName = "稀世异宝兑换狩魔猎人（永久）"},
}
-- 兑换道具名称
...
-- 兑换道具需要数量
x570103_var_ExcItemNum = 1000

x570103_var_QuestName = "#R【兑换稀世异宝】%s"
x570103_var_QuestName1 = "【稀世异宝说明】"
x570103_var_Questintro = "\t你可以在我这里兑换#G稀世奇有#W的时装和坐骑，二十五个稀世奇珍兑换卷就可以兑换其中任意一件时装或者任意一个坐骑降世符。"
x570103_var_Questintro1 ="\n\t#G稀世异宝：成年神马（流星火雨）降世符#W：自带元素技能流星火雨。\n\t#G稀世异宝：成年神马（流星火雨）降世符#W：自带元素技能流星火雨。\n\t#G稀世异宝：成年神马（流星火雨）降世符#W：自带元素技能流星火雨。\n\t#G稀世异宝：决战八方（永久）#W：永久时装，时装穿上去看着就很拉风。\n\t#G稀世异宝：狩魔猎人（永久）#W：永久时装，一样的威武，穿上去看着就很拉风。"
