...
-- 兑换目标道具名称
x588020_var_TargetName = "#R兑换玄甲马装（魔攻）"
-- 兑换目标道具ID
...
-- 兑换道具需要数量
x588020_var_ExcItemNum = 150

x588020_var_QuestName = "【兑换魔攻】%s"
x588020_var_Questintro = "\t你可以用珍贵的战神令在我这里兑换新版的#W玄甲马装，150个战神令就可以兑换任意一件新版玄甲马装。"
	...
	if seleteId == -1 then
		StartTalkTask(varMap)
			...
			for varI, item in x588020_var_ExcObjID  do
				TalkAppendButton( varMap, x588020_var_FileId, "【兑换】兑换"..item.targetName, 3, varI )
			end
		StopTalkTask()
