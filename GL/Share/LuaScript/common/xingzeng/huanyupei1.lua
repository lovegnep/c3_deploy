...
-- 兑换目标道具名称
x588030_var_TargetName = "#R兑换一级神器玉佩"
-- 兑换目标道具ID
...
-- 兑换道具需要数量
x588030_var_ExcItemNum = 10

x588030_var_QuestName = "【兑换】%s"
x588030_var_Questintro = "\t你可以用破碎的和田暖玉在我处兑换神·一级赤血玉佩、神·一级赤金玉佩、神·一级龙象玉佩、神·一级般若玉佩、神·一级兽面玉佩，10个破碎的和田暖玉就可以兑换一件一级神器玉佩。"
	...
	if seleteId == -1 then
		StartTalkTask(varMap)
			...
			for varI, item in x588030_var_ExcObjID  do
				TalkAppendButton( varMap, x588030_var_FileId, "【兑换】兑换"..item.targetName, 3, varI )
			end
		StopTalkTask()
