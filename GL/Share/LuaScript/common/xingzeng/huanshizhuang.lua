...
-- 兑换目标道具名称
x588022_var_TargetName = "#R兑换六星时装"
-- 兑换目标道具ID
...
-- 兑换道具需要数量
x588022_var_ExcItemNum = 300

x588022_var_QuestName = "【兑换时装】%s"
x588022_var_Questintro = "\t你可以用珍贵的战神王牌兑换券在我处兑换神·上古守护（永久）、神·泰坦守护（永久）、神·破魔守护（永久）、神·不朽守护（永久）、神·无畏战神（永久）、神·英勇卫士（永久），300个战神王牌兑换券就可以兑换一件六星时装。"
	...
	if seleteId == -1 then
		StartTalkTask(varMap)
			...
			for varI, item in x588022_var_ExcObjID  do
				TalkAppendButton( varMap, x588022_var_FileId, "【兑换】兑换"..item.targetName, 3, varI )
			end
		StopTalkTask()
