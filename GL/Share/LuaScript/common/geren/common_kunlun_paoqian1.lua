...
x300862_var_FileId 					= 	300862                  

x300862_var_QuestKind 				= 	1                       
x300862_var_LevelLess					= 	30                      

x300862_var_QuestTarget				= 	"将货物安全运到@npc_137501"          
x300862_var_QuestInfo				= 	"\t杀死@npc_72004的@npc_72005,找到@npc_137600"            
x300862_var_ContinueInfo				= 	"怎么还没人送货过来啊？今天送货的人呢？"  
x300862_var_QuestCompleted			= 	"一路辛苦了，这是给您的奖励，请收下！"  
x300862_var_QuestHelp				=	""          


x300862_var_ExtTarget					=	{ {type=20,n=1,target="@npc_72005"} }



x300862_var_BonusItem					=	{}	
x300862_var_BonusMoney6               =   0  

x300862_var_BonusChoiceItem           =   {}

x300862_var_Mis_Count   = 3				

--DECLARE_QUEST_INFO_STOP--


x300862_MP_ISCOMPLETE				= 7	


x300862_TARGET_ITEMID1				= -2



x300862_var_BusScriptId				= 300865


x300862_var_SubQuestID				=	{ { varQuest=7632, varQuestName = "【个人】黑金押运", varQuestTarget = "  将飞行器交给@npc_129174", QuestInfo = "\t一路小赚，押的少风险小啊。\n\t您可以通过王国押运官并抵押#G5两现银#W就可以领取一架#G飞行器#W，当您将飞行器安全护送到指定地点，系统将会#G返还押金#W并奖励您#G2两现银(银卡)#W工钱。\n\t有#G江湖请柬#W或#G朝廷请柬#W状态的玩家奖励为现银，否则奖励为银卡。\n",QuestHelp = "\t您必须#r绑定密保卡后#w才能领取任务，护送途中如果您离开飞行器过远，飞行器会意识到危险而#g停止前进#w。\n\t如果飞行器受到袭击并死亡，您的任务将失败，同时押金将被抢走。\n\t当您离开飞行器一段时间或掉线，飞行器将消失，此时#g任务失败#w，您的#g押金#w将丢失。", SubmitNPCGUID = 129174, varCostMoney =5000, BonusMoney = 2000, varExpBonus = 0,NPCName = "@npc_129174",Questruse="将运金飞行器送到昆仑外城的@npc_132154处！",AcceptId = 281,SubmitId = 282,varLevelLess	= 30,varLevelMax = 40,BaoDanId=13080011 }, 
										  {	varQuest=7633, varQuestName = "【个人】黑金押运", varQuestTarget = "  将飞行器交给@npc_520113", QuestInfo = "\t略有风险，满足一点点小贪心。\n\t您可以通过王国押运官并抵押#G10两现银#W就可以领取一架#G飞行器#W，当您将飞行器安全护送到指定地点，系统将会#G返还押金#W并奖励您#G4两现银(银卡)#W工钱。\n\t有#G江湖请柬#W或#G朝廷请柬#W状态的玩家奖励为现银，否则奖励为银卡。\n",QuestHelp = "\t您必须#r绑定密保卡后#w才能领取任务，护送途中如果您离开飞行器过远，飞行器会意识到危险而#g停止前进#w。\n\t如果飞行器受到袭击并死亡，您的任务将失败，同时押金将被抢走。\n\t当您离开飞行器一段时间或掉线，飞行器将消失，此时#g任务失败#w，您的#g押金#w将丢失。",	SubmitNPCGUID = 520113, varCostMoney = 10000, BonusMoney = 4000, varExpBonus = 0,NPCName = "@npc_520113",Questruse="将运金飞行器送到昆仑古道的@npc_520113处！",AcceptId = 291,SubmitId = 292,varLevelLess = 40,varLevelMax = 50,BaoDanId=13080012 },
										  {	varQuest=7634, varQuestName = "【个人】黑金押运", varQuestTarget = "  将飞行器交给@npc_131514", QuestInfo = "\t舍得，舍得，不舍哪会有得？下定决心才能大富大贵，风险大回报一定丰厚。\n\t您可以通过王国押运官并抵押#G15两现银#W就可以领取一架#G飞行器#W，当您将飞行器安全护送到指定地点，系统将会#G返还押金#W并奖励您#G6两现银(银卡)#W工钱。\n\t有#G江湖请柬#W或#G朝廷请柬#W状态的玩家奖励为现银，否则奖励为银卡。\n",QuestHelp = "\t您必须#r绑定密保卡后#w才能领取任务，护送途中如果您离开飞行器过远，飞行器会意识到危险而#g停止前进#w。\n\t如果飞行器受到袭击并死亡，您的任务将失败，同时押金将被抢走。\n\t当您离开飞行器一段时间或掉线，飞行器将消失，此时#g任务失败#w，您的#g押金#w将丢失。",SubmitNPCGUID = 131514, varCostMoney = 15000,BonusMoney = 6000,varExpBonus = 0,NPCName = "@npc_131514",Questruse="将运金飞行器送到边塞的@npc_131514处！",AcceptId = 301,SubmitId = 302,varLevelLess = 50,varLevelMax = 60,BaoDanId=13080013 },
										  {	varQuest=7635, varQuestName = "【个人】黑金押运", varQuestTarget = "  将飞行器交给@npc_131514", QuestInfo = "\t舍得，舍得，不舍哪会有得？下定决心才能大富大贵，风险大回报一定丰厚。\n\t您可以通过王国押运官并抵押#G30两现银#W就可以领取一架#G飞行器#W，当您将飞行器安全护送到指定地点，系统将会#G返还押金#W并奖励您#G12两现银(银卡)#W工钱。\n\t有#G江湖请柬#W或#G朝廷请柬#W状态的玩家奖励为现银，否则奖励为银卡。\n",QuestHelp = "\t您必须#r绑定密保卡后#w才能领取任务，护送途中如果您离开飞行器过远，飞行器会意识到危险而#g停止前进#w。\n\t如果飞行器受到袭击并死亡，您的任务将失败，同时押金将被抢走。\n\t当您离开飞行器一段时间或掉线，飞行器将消失，此时#g任务失败#w，您的#g押金#w将丢失。",SubmitNPCGUID = 131514, varCostMoney = 30000,BonusMoney = 12000,varExpBonus = 0,NPCName = "@npc_131514",Questruse="将运金飞行器送到边塞的@npc_131514处！",AcceptId = 761,SubmitId = 762,varLevelLess = 60,varLevelMax = 70,BaoDanId=13080014 },
										  { varQuest=7636, varQuestName = "【个人】黑金押运", varQuestTarget = "  将飞行器交给@npc_131514", QuestInfo = "\t舍得，舍得，不舍哪会有得？下定决心才能大富大贵，风险大回报一定丰厚。\n\t您可以通过王国押运官并抵押#G40两现银#W就可以领取一架#G飞行器#W，当您将飞行器安全护送到指定地点，系统将会#G返还押金#W并奖励您#G16两现银(银卡)#W工钱。\n\t有#G江湖请柬#W或#G朝廷请柬#W状态的玩家奖励为现银，否则奖励为银卡。\n",QuestHelp = "\t您必须#r绑定密保卡后#w才能领取任务，护送途中如果您离开飞行器过远，飞行器会意识到危险而#g停止前进#w。\n\t如果飞行器受到袭击并死亡，您的任务将失败，同时押金将被抢走。\n\t当您离开飞行器一段时间或掉线，飞行器将消失，此时#g任务失败#w，您的#g押金#w将丢失。",SubmitNPCGUID = 131514, varCostMoney = 40000,BonusMoney = 16000,varExpBonus = 0,NPCName = "@npc_131514",Questruse="将运金飞行器送到边塞的@npc_131514处！",AcceptId = 771,SubmitId = 772,varLevelLess = 70,varLevelMax = 80,BaoDanId=13080015 },
										  { varQuest=7637, varQuestName = "【个人】黑金押运", varQuestTarget = "  将飞行器交给@npc_131514", QuestInfo = "\t舍得，舍得，不舍哪会有得？下定决心才能大富大贵，风险大回报一定丰厚。\n\t您可以通过王国押运官并抵押#G50两现银#W就可以领取一架#G飞行器#W，当您将飞行器安全护送到指定地点，系统将会#G返还押金#W并奖励您#G20两现银(银卡)#W工钱。\n\t有#G江湖请柬#W或#G朝廷请柬#W状态的玩家奖励为现银，否则奖励为银卡。\n",QuestHelp = "\t您必须#r绑定密保卡后#w才能领取任务，护送途中如果您离开飞行器过远，飞行器会意识到危险而#g停止前进#w。\n\t如果飞行器受到袭击并死亡，您的任务将失败，同时押金将被抢走。\n\t当您离开飞行器一段时间或掉线，飞行器将消失，此时#g任务失败#w，您的#g押金#w将丢失。",SubmitNPCGUID = 131514, varCostMoney = 50000,BonusMoney = 20000,varExpBonus = 0,NPCName = "@npc_131514",Questruse="将运金飞行器送到边塞的@npc_131514处！",AcceptId = 781,SubmitId = 782,varLevelLess = 80,varLevelMax = 150,BaoDanId=13080016 },
										}
						
x300862_var_nGoldsRate = 10			-- 金卡比率



function x300862_ProcEnumEvent( varMap, varPlayer, varTalknpc, varQuest )
	return 0;
end
...
function x300862_ProcEventEntry(varMap, varPlayer, varTalknpc, varQuest,varExtIdx)	
		
	local varIndex = 1
	for varI,itm in x300862_var_SubQuestID do
	...
	if(varHaveQuest > 0) then
		local varDone = x300862_CheckSubmit(varMap, varPlayer, varTalknpc, varIndex);
		if(varDone > 0) then
			if varExtIdx ~= -1 then
				x300862_DispatchCompletedInfo( varMap, varPlayer, varTalknpc,varIndex) 
			end
		else
			if varExtIdx ~= -1 then
				x300862_DispatchContinueInfo( varMap, varPlayer, varTalknpc,varIndex ) 
			end
		end
	else
		local varTalkNpcGUID = GetMonsterGUID(varMap,varTalknpc)
		if x300862_var_SubQuestID[varIndex].SubmitNPCGUID ~= varTalkNpcGUID then
			x300862_DispatchQuestInfo( varMap, varPlayer, varTalknpc,varIndex )	
		else
...
function x300862_ProcAcceptCheck( varMap, varPlayer,varQuest )
	...
	for BaoDanId,BaoDanItm in x300862_var_SubQuestID do
	...
	local varLevelLess = x300862_var_SubQuestID[1].varLevelLess
	local varLevelMax = x300862_var_SubQuestID[1].varLevelMax
	for varI,itm in x300862_var_SubQuestID do
	...
	if x300862_GetDayCount(varMap, varPlayer) >= x300862_var_Mis_Count then
	  	StartTalkTask(varMap)
...
function x300862_ProcQuestAccept( varMap, varPlayer,varTalknpc,varQuest )

	--2011-4-13 by rj 增加对押运交付任务人通过外挂进行的接受任务操作
	local varTalkNpcGUID = GetMonsterGUID(varMap, varTalknpc)
	for i, item in x300862_var_SubQuestID do
		if varTalkNpcGUID == item.SubmitNPCGUID then
			return
		end
	end

	if ( x300862_ProcAcceptCheck( varMap, varPlayer,varQuest ) ~= 1 ) then
	...
	for varI,itm in x300862_var_SubQuestID do
		if varQuest == itm.varQuest then
			LuaCallNoclosure( x300862_var_BusScriptId, "ProcCreateBus", varMap, varPlayer ,varQuest,varI)
			break
		end
	end
...
function  x300862_ProcDatiFail(varMap, varPlayer)
	...
	if GetGameOpenById(1018)>0 then
		...
		x300862_SetDayCount(varMap, varPlayer)
	end
end

function x300862_ProcHeiJinDatiSuccess(varMap, varPlayer)
	...
	if ( x300862_ProcAcceptCheck( varMap, varPlayer,nQuestId ) ~= 1 ) then
	...
	for varI,itm in x300862_var_SubQuestID do
		if nQuestId == itm.varQuest then
			LuaCallNoclosure( x300862_var_BusScriptId, "ProcCreateBus", varMap, varPlayer ,nQuestId,varI)
			break
		end
	end
...
function x300862_CheckSubmit(varMap, varPlayer, varTalknpc, varIndex)
...
function x300862_ProcQuestAbandon(varMap, varPlayer, varQuest)
...
function x300862_GetBonus( varMap, varPlayer,varTalknpc, varButtonClick,varQuest )
	...
	local bHaveImpact3 = IsHaveSpecificImpact( varMap, varPlayer, buffId3 )
		...
		elseif (bHaveImpact3 == 1) then
			BonusMoney = BonusMoney * x300862_var_nGoldsRate
			StartTalkTask(varMap)
			local  Money = floor(BonusMoney/1000)
			StartTalkTask(varMap)
			TalkAppendString(varMap,"您完成了任务了：【个人】黑金押运");
	...
	for varI, item in x300862_var_BonusItem do
	...
	for varI, item in x300862_var_BonusChoiceItem do
...
function x300862_ProcQuestSubmit(varMap, varPlayer, varTalknpc, varRadioSelected,varQuest)
	...
	if varHaveQuest > 0 then
		...
		local result = x300862_CheckPlayerBagFull(varMap,varPlayer,varRadioSelected)
		if result == 1 then
			...
			x300862_GetBonus( varMap,varPlayer,varTalknpc,varRadioSelected,varQuest )
...
function x300862_CheckPlayerBagFull( varMap ,varPlayer,selectRadio )
	...
	StartItemTask(varMap)
	for j, item in x300862_var_BonusItem do
		ItemAppend( varMap, item.item, item.n )
    end

	for j, item in x300862_var_BonusChoiceItem do
...
function x300862_DispatchQuestInfo( varMap, varPlayer, varTalknpc,varIndex )

	StartTalkTask(varMap)

		
		TalkAppendString(varMap,"#Y"..x300862_var_SubQuestID[varIndex].varQuestName)
		TalkAppendString(varMap,format("%s", x300862_var_SubQuestID[varIndex].QuestInfo))
		TalkAppendString(varMap," ")

		
		TalkAppendString( varMap,"#Y任务目标：")
		TalkAppendString( varMap,format("%s", x300862_var_SubQuestID[varIndex].varQuestTarget))
		TalkAppendString( varMap," ")

		
		if x300862_var_QuestHelp ~= "" then

			TalkAppendString(varMap,"#Y任务提示：")
			TalkAppendString(varMap,format("%s", x300862_var_SubQuestID[varIndex].QuestHelp))
			TalkAppendString(varMap," ")
		end
		...
		local varExpBonus = x300862_var_SubQuestID[varIndex].varExpBonus
		if varExpBonus > 0 then
			local varLevel = GetLevel(varMap, varPlayer)
			varExpBonus = x300862_var_SubQuestID[varIndex].varExpBonus * varLevel
			AddQuestExpBonus(varMap, varExpBonus )
		end

		

		if x300862_var_SubQuestID[varIndex].BonusMoney > 0 then
    		local buffId1 = 9011
	        local buffId2 = 9013
	        local buffId3 = 9012
	        local bHaveImpact1 = IsHaveSpecificImpact( varMap, varPlayer, buffId1 )
			...
			AddQuestMoneyBonus2(varMap, x300862_var_SubQuestID[varIndex].BonusMoney )
		    elseif (bHaveImpact3 == 1) then
				local BonusMoney = x300862_var_SubQuestID[varIndex].BonusMoney * x300862_var_nGoldsRate
				AddQuestMoneyBonus3(varMap, BonusMoney )
		    else 
		    AddQuestMoneyBonus1(varMap, x300862_var_SubQuestID[varIndex].BonusMoney )
		end
		end

		
		if x300862_var_BonusMoney6 > 0 then
			AddQuestMoneyBonus6(varMap, x300862_var_BonusMoney6 )
		end
	...
	StopTalkTask(varMap)
	DeliverTalkInfoNM(varMap, varPlayer, varTalknpc, x300862_var_FileId, x300862_var_SubQuestID[varIndex].varQuest);
end




function x300862_DispatchContinueInfo( varMap, varPlayer, varTalknpc,varIndex )
	...
	StartTalkTask(varMap)
		...
		if x300862_var_SubQuestID[varIndex].BonusMoney > 0 then
			...
			AddQuestMoneyBonus(varMap, x300862_var_SubQuestID[varIndex].BonusMoney )
	...
	DeliverTalkRequire(varMap, varPlayer, varTalknpc, x300862_var_FileId, x300862_var_SubQuestID[varIndex].varQuest,0);
...
function x300862_DispatchCompletedInfo( varMap, varPlayer, varTalknpc,varIndex )
	
	StartTalkTask(varMap)

		
		TalkAppendString(varMap,"#Y"..x300862_var_SubQuestID[varIndex].varQuestName)
		TalkAppendString(varMap,x300862_var_QuestCompleted)
		TalkAppendString(varMap," ")
	...
	StopTalkTask(varMap)
	DeliverTalkContinueNM(varMap, varPlayer, varTalknpc, x300862_var_FileId, x300862_var_SubQuestID[varIndex].varQuest);
...
function x300862_ProcQuestAttach( varMap, varPlayer, varTalknpc, varTalkNpcGUID, varQuestIdx, varQuest )
	for varI,itm in x300862_var_SubQuestID do
		local varHaveQuest = IsHaveQuestNM(varMap, varPlayer,itm.varQuest );
...
function x300862_QuestLogRefresh( varMap, varPlayer, varQuest)
...
function x300862_ProcQuestLogRefresh( varMap, varPlayer, varQuest)

	x300862_QuestLogRefresh( varMap, varPlayer, varQuest );
end

function x300862_CostMoney( varMap, varPlayer,varQuest )
	for varI,itm in x300862_var_SubQuestID do
		if varQuest == itm.varQuest  then
...
function x300862_ProcQuestObjectKilled( varMap, varPlayer, varObjData, varObj, varQuest )
end
...
function x300862_GetDayCount(varMap, varPlayer)

	if x300862_var_Mis_Count > 0 then
...
function x300862_SetDayCount(varMap, varPlayer)
	local varToday = GetDayOfYear()
