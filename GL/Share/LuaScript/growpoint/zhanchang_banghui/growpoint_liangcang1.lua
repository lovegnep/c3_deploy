...
x300662_var_GatherPointTypeId = 106 		
x300662_var_ItemId = 12010001
x300662_var_BufIndex = 1210


function 	x300662_ProcGpCreate(varMap,varGpType,varX,varY)
	local varBoxId = ItemBoxEnterScene(varX, varY, x300662_var_GatherPointTypeId, varMap, 0, x300662_var_ItemId)
end




function	 x300662_ProcGpOpen(varMap,varPlayer,varTalknpc)
    return x300662_ProcGpOpenItemBox(varMap, varPlayer, varTalknpc, x300662_var_GatherPointTypeId, x300662_var_ItemId)
end




function	 x300662_ProcGpRecycle(varMap,varPlayer,varTalknpc)
	return   x300662_ProcGuildRecycle( varMap, varPlayer, varTalknpc, x300662_var_GatherPointTypeId, x300662_var_ItemId )
end
...
function	x300662_ProcGpProcOver(varMap,varPlayer,varTalknpc)
...
function	x300662_OpenCheck(varMap,varPlayer,AbilityId,AblityLevel)
...
function x300662_ProcGpOpenItemBox( varMap, varPlayer, varTalknpc, varGpType, varNeedItem )
	...
	local guild = GetGuildBattleSceneData_Param(varMap,LD_GUILD_BATTLE_BARN1_GUILD)
...
function x300662_ProcGuildRecycle( varMap, varPlayer, varTalknpc, varGpType, varNeedItem )
	...
	SetGuildBattleSceneData_Param( varMap,LD_GUILD_BATTLE_BARN1_GUILD,GetGuildID(varMap, varPlayer) )

	
	SetGuildBattleSceneData_Param( varMap,LD_GUILD_BATTLE_BARN1_TIME,-1 )

    LuaCallNoclosure( GUILDBATTLE_SCRIPTID,"UpdateSceneDataFlag",varMap,1 )
