...
x300668_var_GatherPointTypeId = 113 		
x300668_var_ItemId = 12010001
x300668_var_Flag = 1             		
x300668_var_BufIndex = 1210


function 	x300668_ProcGpCreate(varMap,varGpType,varX,varY)
	local varBoxId = ItemBoxEnterScene(varX, varY, x300668_var_GatherPointTypeId, varMap, 0, x300668_var_ItemId)
end




function	 x300668_ProcGpOpen(varMap,varPlayer,varTalknpc)
    return x300668_ProcGpOpenItemBox(varMap, varPlayer, varTalknpc, x300668_var_GatherPointTypeId, x300668_var_ItemId)
end




function	 x300668_ProcGpRecycle(varMap,varPlayer,varTalknpc)
	return   x300668_ProcGuildRecycle( varMap, varPlayer, varTalknpc, x300668_var_GatherPointTypeId, x300668_var_ItemId )
end
...
function	x300668_ProcGpProcOver(varMap,varPlayer,varTalknpc)
...
function	x300668_OpenCheck(varMap,varPlayer,AbilityId,AblityLevel)
	
end



function x300668_ProcGpOpenItemBox( varMap, varPlayer, varTalknpc, varGpType, varNeedItem )
	...
	if nFlag ~= x300668_var_Flag then      
...
function x300668_ProcGuildRecycle( varMap, varPlayer, varTalknpc, varGpType, varNeedItem )
