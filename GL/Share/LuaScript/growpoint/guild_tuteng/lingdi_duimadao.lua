...
x301463_var_GatherPointTypeId = 141 
x301463_var_ItemId = 13011608 
x301463_var_BufIndex = 7600
x301463_var_GroupPoint	=	{ {type=10,varId =141,target = "丹木"}}
--DECLARE_QUEST_INFO_STOP--

x301463_var_Growpointlevel = {
...
x301463_var_GrowpointPos = {
							 {posx1=56, posz1=148,posx2=196, posz2=173,posx3=88, posz3=198,
							 },							
		}		


function 	x301463_ProcGpCreate(varMap,varGpType,varX,varY)
	
	local varBoxId = ItemBoxEnterScene(varX, varY, x301463_var_GatherPointTypeId, varMap, 0, x301463_var_ItemId)
	SetGrowPointObjID(varMap,x301463_var_GatherPointTypeId,varX, varY,varBoxId)
end




function	 x301463_ProcGpOpen(varMap,varPlayer,varTalknpc)
	return x301463_ProcGpOpenItemBox(varMap, varPlayer, varTalknpc, x301463_var_GatherPointTypeId, x301463_var_ItemId)
...
function	 x301463_ProcGpRecycle(varMap,varPlayer,varTalknpc)
	return   x301463_ProcGuildRecycle( varMap, varPlayer, varTalknpc, x301463_var_GatherPointTypeId, x301463_var_ItemId )
...
function	x301463_ProcGpProcOver(varMap,varPlayer,varTalknpc)
...
function x301463_OpenCheck(varMap,varPlayer,AbilityId,AblityLevel)
...
function x301463_GetQuestDesc(varMap, varPlayer)
	for varI,itm in x301463_var_Growpointlevel do
...
function x301463_ProcGpOpenItemBox( varMap, varPlayer, varTalknpc, varGpType, varNeedItem )
	local varQuestDesc = x301463_GetQuestDesc(varMap, varPlayer)
	...
	if varMap == 26 and varLevel > 115 then
		StartTalkTask(varMap)
	...
	if varMap == 27 and varLevel > 120 then
		StartTalkTask(varMap)
		TalkAppendString(varMap,"您的等级过高")
		StopTalkTask(varMap)
		DeliverTalkTips(varMap,varPlayer)
	...
	if varMap == 29 and varLevel > 130 then
		StartTalkTask(varMap)
		TalkAppendString(varMap,"您的等级过高")
		StopTalkTask(varMap)
		DeliverTalkTips(varMap,varPlayer)
...
function x301463_ProcGuildRecycle( varMap, varPlayer, varTalknpc, varGpType, varNeedItem )
	local varQuestDesc = x301463_GetQuestDesc(varMap, varPlayer)
	if varQuestDesc == nil then
		return 1
	end
	...
	if varLevel <=  130 then
		if varMap == 26 then
			 ...
			 if varRet <= 10 then 
					...
					CreateMonster(varMap,3059,x301463_var_GrowpointPos[1].posx1, x301463_var_GrowpointPos[1].posz1, 16,-1, -1,13079463,21,1000 * 60 *15 )
					CreateMonster(varMap,3059,x301463_var_GrowpointPos[1].posx2, x301463_var_GrowpointPos[1].posz2, 16,-1, -1,13079463,21,1000 * 60 *15 )
					CreateMonster(varMap,3059,x301463_var_GrowpointPos[1].posx3, x301463_var_GrowpointPos[1].posz3, 16,-1, -1,13079463,21,1000 * 60 *15 )
