...
x270012_var_QuestIdPre =3590
x270012_var_QuestId = 3593
x270012_var_LevelLess	= 	78 
x270012_var_QuestIdNext = 3594
x270012_var_Name	={}
x270012_var_noDemandItem ={{varId=13020324,varNum=1}}
x270012_var_ExtTarget={{type=20,n=1,target="到@npc_141012处使用@itemid_13020324之后按照道士的指示去做完成仪式"}}
x270012_var_QuestName="【主线】破镜重圆"
x270012_var_QuestInfo="\t据我所知，这附近有一种叫做饕餮的异兽，生性贪吃法力却不小，你可以用我给你的水玉加上野猪腿来喂它，等它缩小到一定的程度就可以擒住它来拼合破碎的镜子。\n\t至于能不能将它顺利地引诱出来复原镜子，贫道也没有把握。"  
...
function x270012_useitem(varMap,varPlayer)
		...
		local distanceRet = 25 - (403 - PlayerPosX) * (403 - PlayerPosX) - (434 - PlayerPosZ) * (434 - PlayerPosZ)
			...
			if GetQuestParam(varMap,varPlayer,varQuestIdx,0) == 0 then
				if x270012_var_doing==0   then
						...
						if x270012_var_PROTECTINFO.ScneneTimerIndex >= 0 then
								x270012_var_doing = 1
								x270012_var_daotong=CreateMonster(varMap, 1167,403,434,3,1,-1,-1,20,98000,0,"巫山真人")
		...
		elseif which == 1 then
				if x270012_var_doing == 5   then
					if IsObjValid (varMap,x270012_var_daotong) == 1 then
						SetPatrolId(varMap, x270012_var_daotong, 55)
					end
					if IsObjValid (varMap,x270012_var_taotie) == 1 then
						SetPatrolId(varMap, x270012_var_taotie, 54)
					end
					if IsObjValid (varMap,x270012_var_daotong) == 1 then
						NpcTalk(varMap, x270012_var_daotong, "好的，我们继续！", -1)
					end
						CreateMonster(varMap, 1622,399, 442,3,1,-1,-1,20,8000,0," ")
						x270012_var_PROTECTINFO.StartTime2 = GetCurrentTime()
						x270012_var_doing2= 0
    				return 1
    		elseif x270012_var_doing == 6   then
    			if IsObjValid (varMap,x270012_var_daotong) == 1 then
						SetPatrolId(varMap, x270012_var_daotong, 56)
						NpcTalk(varMap, x270012_var_daotong, "好的，我们继续！", -1)
					end
					if IsObjValid (varMap,x270012_var_taotie) == 1 then
						SetPatrolId(varMap, x270012_var_taotie, 55)
					end
						CreateMonster(varMap, 1622,385, 443,3,1,-1,-1,20,8000,0," ")
						x270012_var_PROTECTINFO.StartTime2 = GetCurrentTime()
						x270012_var_doing2= 0
    				return 1
    		elseif x270012_var_doing == 7   then
    			if IsObjValid (varMap,x270012_var_daotong) == 1 then
						SetPatrolId(varMap, x270012_var_daotong, 57)
						NpcTalk(varMap, x270012_var_daotong, "好的，我们继续！", -1)
					end
					if IsObjValid (varMap,x270012_var_taotie) == 1 then
						SetPatrolId(varMap, x270012_var_taotie, 56)
					end
						CreateMonster(varMap, 1622,374,437,3,1,-1,-1,20,8000,0," ")
						x270012_var_PROTECTINFO.StartTime2 = GetCurrentTime()
						x270012_var_doing2= 0
    				return 1
    		elseif x270012_var_doing == 8   then
    			if IsObjValid (varMap,x270012_var_daotong) == 1 then
						SetPatrolId(varMap, x270012_var_daotong, 58)
						NpcTalk(varMap, x270012_var_daotong, "好了等它来就好了！", -1)
					end
					if IsObjValid (varMap,x270012_var_taotie) == 1 then
						SetPatrolId(varMap, x270012_var_taotie, 57)
					end
						CreateMonster(varMap, 1622,367,447,3,1,-1,-1,20,8000,0," ")
						x270012_var_PROTECTINFO.StartTime2 = GetCurrentTime()
						x270012_var_doing2= 0
    				return 1
    		end
	...
	elseif x270012_var_doing == 2   then
			if GetCurrentTime() - x270012_var_PROTECTINFO.StartTime >= 5   then
				if IsObjValid (varMap,x270012_var_daotong) == 1 then
						...
						SetPatrolId(varMap, x270012_var_daotong, 54)
				end
        x270012_var_doing =3
			end
	elseif x270012_var_doing == 3   then
			if GetCurrentTime() - x270012_var_PROTECTINFO.StartTime >= 6   then
						x270012_var_taotie=CreateMonster(varMap, 1620,408,431,3,1,-1,-1,20,96000,315,"饕餮")
						x270012_var_PROTECTINFO.StartTime2 = GetCurrentTime()
        x270012_var_doing =4
			end
	...
	if x270012_var_doing2== 0 then
		if GetCurrentTime() - x270012_var_PROTECTINFO.StartTime2 >= 8   then
			if x270012_var_doing == 4   then
						ItemBoxEnterScene(399, 442, 16, varMap, 0, 13020324,90000)
						if IsObjValid (varMap,x270012_var_daotong) == 1 then
      ...
      elseif x270012_var_doing == 5   then
						ItemBoxEnterScene(385, 443, 16, varMap, 0, 13020324,80000)
						if IsObjValid (varMap,x270012_var_daotong) == 1 then
								NpcTalk(varMap, x270012_var_daotong, "快来把水玉涂在上面！", -1)
						end
						if IsObjValid (varMap,x270012_var_taotie) == 1 then
        		...
        		x270012_var_doing2= 1
     elseif x270012_var_doing == 6   then
						ItemBoxEnterScene(374,437, 16, varMap, 0, 13020324,70000)
						if IsObjValid (varMap,x270012_var_daotong) == 1 then
								NpcTalk(varMap, x270012_var_daotong, "快来把水玉涂在上面！", -1)
						end
						if IsObjValid (varMap,x270012_var_taotie) == 1 then
        		...
        		x270012_var_doing2= 1
     elseif x270012_var_doing == 7   then
						ItemBoxEnterScene(367,447, 16, varMap, 0, 13020324,60000)
						if IsObjValid (varMap,x270012_var_daotong) == 1 then
								NpcTalk(varMap, x270012_var_daotong, "快来把水玉涂在上面！", -1)
						end
						if IsObjValid (varMap,x270012_var_taotie) == 1 then
