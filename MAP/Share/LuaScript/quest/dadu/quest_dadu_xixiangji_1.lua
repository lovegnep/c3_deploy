...
x270011_var_QuestIdPre =3585
x270011_var_QuestId = 3586
x270011_var_LevelLess	= 	78 
x270011_var_QuestIdNext = 3587
x270011_var_Name	={}
x270011_var_ExtTarget={{type=20,n=1,target="到@npc_141011处等待张生把孙飞虎引出来后杀了孙飞虎"}}
x270011_var_QuestName="【主线】美人险计"
			...
			if x270011_var_doing == 0 then
				if x270011_CheckSubmit(varMap, varPlayer) <= 0 then
							...
							if x270011_var_PROTECTINFO.ScneneTimerIndex >= 0 then
									x270011_var_doing = 1
									x270011_var_sunfeihu=CreateMonster(varMap, 17,155,475,5,1,-1,-1,20,80000,180,"孙飞虎")
									x270011_var_huwei1=CreateMonster(varMap, 9,151,477,3,1,-1,-1,20,80000,180,"护卫")
									x270011_var_huwei2=CreateMonster(varMap, 9,151,473,3,1,-1,-1,20,80000,180,"护卫")
									if IsObjValid (varMap,x270011_var_sunfeihu) == 1 then
											SetPatrolId(varMap, x270011_var_sunfeihu, 49)
									end
									if IsObjValid (varMap,x270011_var_huwei1) == 1 then
											SetPatrolId(varMap, x270011_var_huwei1, 50)
									end
									if IsObjValid (varMap,x270011_var_huwei2) == 1 then
											SetPatrolId(varMap, x270011_var_huwei2, 51)
									end
							end
...
function x270011_ProcScneneTimer(varMap)
	if x270011_var_doing==1   then
		if GetCurrentTime() - x270011_var_PROTECTINFO.StartTime >= 3   then
						x270011_var_doing = 2
						if IsObjValid (varMap,x270011_var_sunfeihu) == 1 then
	...
	elseif x270011_var_doing==3   then
		if GetCurrentTime() - x270011_var_PROTECTINFO.StartTime >= 9   then
						x270011_var_doing = 4
						if IsObjValid (varMap,x270011_var_sunfeihu) == 1 then
	...
	elseif x270011_var_doing==5   then
		if GetCurrentTime() - x270011_var_PROTECTINFO.StartTime >= 14   then
						...
						x270011_var_zhangsheng=CreateMonster(varMap, 4394,169,465,3,1,-1,-1,20,30000,0,"崔莺莺","张生扮")
		end
	elseif x270011_var_doing==6   then
		if GetCurrentTime() - x270011_var_PROTECTINFO.StartTime >= 16   then
						...
						if IsObjValid (varMap,x270011_var_huwei1) == 1 then
								SetMonsterDir(varMap,x270011_var_huwei1,180)
						end
		end
	elseif x270011_var_doing==7   then
		if GetCurrentTime() - x270011_var_PROTECTINFO.StartTime >= 18   then
						...
						if IsObjValid (varMap,x270011_var_sunfeihu) == 1 then
								SetMonsterDir(varMap,x270011_var_sunfeihu,180)
						end
						if IsObjValid (varMap,x270011_var_huwei2) == 1 then
								SetMonsterDir(varMap,x270011_var_huwei2,180)
						end
		end
	elseif x270011_var_doing==8   then
		if GetCurrentTime() - x270011_var_PROTECTINFO.StartTime >= 21   then
						x270011_var_doing = 9
						if IsObjValid (varMap,x270011_var_huwei2) == 1 then
								NpcTalk(varMap, x270011_var_huwei2, "呀！她怎么掉头走了！", -1)
						end
						if IsObjValid (varMap,x270011_var_zhangsheng) == 1 then
								SetPatrolId(varMap, x270011_var_zhangsheng, 52)
						end
		end
	elseif x270011_var_doing==9   then
		if GetCurrentTime() - x270011_var_PROTECTINFO.StartTime >= 24   then
						...
						if IsObjValid (varMap,x270011_var_sunfeihu) == 1 then
								NpcTalk(varMap, x270011_var_sunfeihu, "害羞了?我喜欢！", -1)
								SetPatrolId(varMap, x270011_var_sunfeihu, 53)
						end
		end
	elseif x270011_var_doing==10   then
		if GetCurrentTime() - x270011_var_PROTECTINFO.StartTime >= 26   then
						...
						if IsObjValid (varMap,x270011_var_huwei2) == 1 then
								NpcTalk(varMap, x270011_var_huwei2, "咱俩在这等着吧！", -1)
						end
		end
	elseif x270011_var_doing==11   then
		if GetCurrentTime() - x270011_var_PROTECTINFO.StartTime >= 28   then
						x270011_var_doing = 12
						if IsObjValid (varMap,x270011_var_huwei1) == 1 then
								NpcTalk(varMap, x270011_var_huwei1, "恩，我打赌一炷香时间他就能回来！", -1)
								SetMonsterDir(varMap,x270011_var_huwei1,90)
						end
						if IsObjValid (varMap,x270011_var_huwei2) == 1 then
								SetMonsterDir(varMap,x270011_var_huwei2,90)
						end
		end
	elseif x270011_var_doing==12   then
		if GetCurrentTime() - x270011_var_PROTECTINFO.StartTime >= 32   then
						x270011_var_doing = 13
						if IsObjValid (varMap,x270011_var_sunfeihu) == 1 then
								NpcTalk(varMap, x270011_var_sunfeihu, "大爷看你能跑到哪里！", -1)
						end
		end
	elseif x270011_var_doing==13   then
		if GetCurrentTime() - x270011_var_PROTECTINFO.StartTime >= 36   then
						x270011_var_doing = 14
						if IsObjValid (varMap,x270011_var_zhangsheng) == 1 then
								SetMonsterDir(varMap,x270011_var_zhangsheng,50)
						end
		end
	elseif x270011_var_doing==14   then
		if GetCurrentTime() - x270011_var_PROTECTINFO.StartTime >= 38   then
						x270011_var_doing = 15
						if IsObjValid (varMap,x270011_var_sunfeihu) == 1 then
								NpcTalk(varMap, x270011_var_sunfeihu, "居然是男的？竟敢戏耍大爷？你到底是谁？", -1)
								SetMonsterCamp(varMap,x270011_var_sunfeihu,21)
						end
		end
	elseif x270011_var_doing==15   then
		if GetCurrentTime() - x270011_var_PROTECTINFO.StartTime >= 40   then
						x270011_var_doing = 16
						if IsObjValid (varMap,x270011_var_zhangsheng) == 1 then
								NpcTalk(varMap, x270011_var_zhangsheng, "大侠，剩下的拜托你了！", -1)
						end
		end
	elseif x270011_var_doing==16   then
		if GetCurrentTime() - x270011_var_PROTECTINFO.StartTime >= 43   then
						x270011_var_doing = 17
		end
	elseif x270011_var_doing==17 then
			if GetCurrentTime() - x270011_var_PROTECTINFO.StartTime >= 81   then
