...
x430101_var_FileId 		= 430101 


x430101_var_LevelMin		= 20
x430101_var_LevelMax		= 30

x430101_var_Exp           = 50000





function x430101_ProcEventEntry( varMap, varPlayer, varBagIdx)
...
function x430101_ProcIsSpellLikeScript( varMap, varPlayer)
	return 1; 
end
...
function x430101_ProcCancelImpacts( varMap, varPlayer)
	return 0; 
end
...
function x430101_ProcConditionCheck( varMap, varPlayer)
	
	if( 1~=VerifyUsedItem( varMap, varPlayer) ) then
		return 0
	end
    local varLevel = GetLevel( varMap, varPlayer)
    if varLevel < x430101_var_LevelMin then
        Msg2Player( varMap, varPlayer, "您的等级低于使用此物品的最低级别", 8, 3)
        return 0
    end
    if varLevel >= x430101_var_LevelMax then
...
function x430101_ProcDeplete( varMap, varPlayer)
...
function x430101_ProcActivateOnce( varMap, varPlayer, varImpact)
    ...
    AddExp( varMap, varPlayer, x430101_var_Exp)
...
function x430101_ProcActivateEachTick( varMap, varPlayer)
	return 1; 
end
