...
x430107_var_FileId 		= 430107 


x430107_var_LevelMin		= 80
x430107_var_LevelMax		= 90

x430107_var_Exp           = 1120000




function x430107_ProcEventEntry( varMap, varPlayer, varBagIdx)
...
function x430107_ProcIsSpellLikeScript( varMap, varPlayer)
	return 1; 
end
...
function x430107_ProcCancelImpacts( varMap, varPlayer)
	return 0; 
end
...
function x430107_ProcConditionCheck( varMap, varPlayer)
	
	if( 1~=VerifyUsedItem( varMap, varPlayer) ) then
		return 0
	end
    local varLevel = GetLevel( varMap, varPlayer)
    if varLevel < x430107_var_LevelMin then
        Msg2Player( varMap, varPlayer, "你的等级低于使用此物品的最低级别", 8, 3)
        return 0
    end
    if varLevel >= x430107_var_LevelMax then
...
function x430107_ProcDeplete( varMap, varPlayer)
...
function x430107_ProcActivateOnce( varMap, varPlayer, varImpact)
    ...
    AddExp( varMap, varPlayer, x430107_var_Exp)
...
function x430107_ProcActivateEachTick( varMap, varPlayer)
	return 1; 
end
