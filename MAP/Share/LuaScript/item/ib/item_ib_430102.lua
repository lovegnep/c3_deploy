...
x430102_var_FileId 		= 430102 


x430102_var_LevelMin		= 30
x430102_var_LevelMax		= 40

x430102_var_Exp           = 270000





function x430102_ProcEventEntry( varMap, varPlayer, varBagIdx)
...
function x430102_ProcIsSpellLikeScript( varMap, varPlayer)
	return 1; 
end
...
function x430102_ProcCancelImpacts( varMap, varPlayer)
	return 0; 
end
...
function x430102_ProcConditionCheck( varMap, varPlayer)
	
	if( 1~=VerifyUsedItem( varMap, varPlayer) ) then
		return 0
	end
    local varLevel = GetLevel( varMap, varPlayer)
    if varLevel < x430102_var_LevelMin then
        Msg2Player( varMap, varPlayer, "你的等级低于使用此物品的最低级别", 8, 3)
        return 0
    end
    if varLevel >= x430102_var_LevelMax then
...
function x430102_ProcDeplete( varMap, varPlayer)
...
function x430102_ProcActivateOnce( varMap, varPlayer, varImpact)
    ...
    AddExp( varMap, varPlayer, x430102_var_Exp)
...
function x430102_ProcActivateEachTick( varMap, varPlayer)
	return 1; 
end
