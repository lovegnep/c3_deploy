...
function x418112_ProcEventEntry( varMap, varPlayer, varBagIdx )
...
function x418112_ProcIsSpellLikeScript( varMap, varPlayer)
	return 1; 
end
...
function x418112_ProcCancelImpacts( varMap, varPlayer )
	return 0; 
end
...
function x418112_ProcConditionCheck( varMap, varPlayer )
...
function x418112_ProcDeplete( varMap, varPlayer )
	return 1;
end
...
function x418112_ProcActivateOnce( varMap, varPlayer, varImpact )
	if(DepletingUsedItem(varMap, varPlayer)) == 1 then
		SendSpecificImpactToUnit(varMap, varPlayer, varPlayer, varPlayer,8348, 0);

		
		x418112_ProcTopListYanghua(varMap,varPlayer)
...
function x418112_ProcActivateEachTick( varMap, varPlayer)
	return 1; 
end
...
function x418112_ProcTopListYanghua(varMap,varPlayer)
