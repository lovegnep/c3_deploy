x418340_var_FileId = 418340 


function x418340_ProcEventEntry( varMap, varPlayer, varBagIdx )

end

function x418340_ProcIsSpellLikeScript( varMap, varPlayer)
	return 1; 
	
	
end

function x418340_ProcCancelImpacts( varMap, varPlayer )
	return 0; 
end

function x418340_ProcConditionCheck( varMap, varPlayer )
...
function x418340_ProcDeplete( varMap, varPlayer )

	return 1
end

function x418340_ProcActivateOnce( varMap, varPlayer )
...
function x418340_ProcActivateEachTick( varMap, varPlayer)
	return 1; 
end
