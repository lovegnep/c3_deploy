x418344_var_FileId = 418344 


function x418344_ProcEventEntry( varMap, varPlayer, varBagIdx )

end

function x418344_ProcIsSpellLikeScript( varMap, varPlayer)
	return 1; 
	
	
end

function x418344_ProcCancelImpacts( varMap, varPlayer )
	return 0; 
end

function x418344_ProcConditionCheck( varMap, varPlayer )
...
function x418344_ProcDeplete( varMap, varPlayer )

	return 1
end

function x418344_ProcActivateOnce( varMap, varPlayer )
	...
	ItemAppendBind( varMap, 12030687, 1 ) --平衡神水大礼包1个
	ItemAppendBind( varMap, 12030697, 1 ) --神水奖券1个
...
function x418344_ProcActivateEachTick( varMap, varPlayer)
	return 1; 
end
