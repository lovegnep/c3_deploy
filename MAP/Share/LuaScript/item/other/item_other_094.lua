...
function x418094_ProcEventEntry( varMap, varPlayer, varBagIdx )
...
function x418094_ProcIsSpellLikeScript( varMap, varPlayer)
	return 1; 
end
...
function x418094_ProcCancelImpacts( varMap, varPlayer )
	return 0; 
end
...
function x418094_ProcConditionCheck( varMap, varPlayer )
...
function x418094_ProcDeplete( varMap, varPlayer )
	return 1;
end
...
function x418094_ProcActivateOnce( varMap, varPlayer, varImpact )
	if(DepletingUsedItem(varMap, varPlayer)) == 1 then
		SendSpecificImpactToUnit(varMap, varPlayer, varPlayer, varPlayer,8339, 0);

		
		x418094_ProcTopListYanghua(varMap,varPlayer)
...
function x418094_ProcActivateEachTick( varMap, varPlayer)
	return 1; 
end
...
function x418094_ProcTopListYanghua(varMap,varPlayer)
