...
x418456_var_FileId 		= 418456

x418456_var_LevelMin		=	1





function x418456_ProcEventEntry( varMap, varPlayer, varBagIdx )
...
function x418456_ProcIsSpellLikeScript( varMap, varPlayer)
	return 1; 
end
...
function x418456_ProcCancelImpacts( varMap, varPlayer )
	return 0; 
end
...
function x418456_ProcConditionCheck( varMap, varPlayer )
...
function x418456_ProcDeplete( varMap, varPlayer )
...
function x418456_ProcActivateOnce( varMap, varPlayer, varImpact )
	...
	if ret > 0 then 
		if(DepletingUsedItem(varMap, varPlayer)) == 1 then
			...
			GamePlayScriptLog( varMap, varPlayer, 3015)
		else
...
function x418456_ProcActivateEachTick( varMap, varPlayer)
	return 1; 
end
