...
x418046_var_FileId = 418046
x418046_var_ItemList = {}
x418046_var_LevelMin = 30	
...
function x418046_ProcEventEntry( varMap, varPlayer, varBagIdx )
...
function x418046_ProcIsSpellLikeScript( varMap, varPlayer)
	return 1; 
end
...
function x418046_ProcCancelImpacts( varMap, varPlayer )
	return 0; 
end
...
function x418046_ProcConditionCheck( varMap, varPlayer )
...
function x418046_ProcDeplete( varMap, varPlayer )
...
function x418046_ProcActivateOnce( varMap, varPlayer, varImpact )
	
	if GetLevel(varMap, varPlayer)< x418046_var_LevelMin then
	...
	if varRet > 0 and settrue > 0 then
		...
		local a = CreateHorseToPlayer(varMap,varPlayer,3801,-1)	
...
function x418046_ProcActivateEachTick( varMap, varPlayer)
	return 1; 
end
