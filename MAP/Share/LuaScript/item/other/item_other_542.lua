...
x418542_var_FileId 		= 418542

x418542_var_LevelMin		=	1





function x418542_ProcEventEntry( varMap, varPlayer, varBagIdx )
...
function x418542_ProcIsSpellLikeScript( varMap, varPlayer)
	return 1; 
end
...
function x418542_ProcCancelImpacts( varMap, varPlayer )
	return 0; 
end
...
function x418542_ProcConditionCheck( varMap, varPlayer )
...
function x418542_ProcDeplete( varMap, varPlayer )
...
function x418542_ProcActivateOnce( varMap, varPlayer, varImpact )
...
function x418542_ProcActivateEachTick( varMap, varPlayer)
	return 1; 
end
