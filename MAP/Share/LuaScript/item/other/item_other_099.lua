...
function x418099_ProcEventEntry( varMap, varPlayer, varBagIdx )
...
function x418099_ProcIsSpellLikeScript( varMap, varPlayer)
	return 1; 
end
...
function x418099_ProcCancelImpacts( varMap, varPlayer )
	return 0; 
end
...
function x418099_ProcConditionCheck( varMap, varPlayer )
...
function x418099_ProcDeplete( varMap, varPlayer )
	return 1;
end
...
function x418099_ProcActivateOnce( varMap, varPlayer, varImpact )
	if(DepletingUsedItem(varMap, varPlayer)) == 1 then
		SendSpecificImpactToUnit(varMap, varPlayer, varPlayer, varPlayer,8344, 0);

		
		x418099_ProcTopListYanghua(varMap,varPlayer)
...
function x418099_ProcActivateEachTick( varMap, varPlayer)
	return 1; 
end
...
function x418099_ProcTopListYanghua(varMap,varPlayer)
