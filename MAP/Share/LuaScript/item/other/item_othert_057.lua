...
x432057_var_FileId = 432057
x432057_var_LevelMin = 1	

x432057_var_ItemTable             = {
...
--事件交互入口
--**********************************
function x432057_ProcEventEntry( varMap, varPlayer, varBagIdx )
-- 不需要这个接口，但要保留空函数
end
...
--**********************************
function x432057_ProcIsSpellLikeScript( varMap, varPlayer)
	return 1; --这个脚本需要动作支持
end
...
--**********************************
function x432057_ProcCancelImpacts( varMap, varPlayer )
...
--**********************************
function x432057_ProcConditionCheck( varMap, varPlayer )
...
--**********************************
function x432057_ProcDeplete( varMap, varPlayer )
...
--注：这里是技能生效一次的入口
--**********************************
function x432057_ProcActivateOnce( varMap, varPlayer, varImpact )

	local lv = GetLevel(varMap, varPlayer)
	if lv < x432057_var_LevelMin then
    ...
    for varI, item in x432057_var_ItemTable do
      ...
      giveitem = x432057_var_ItemTable[ varIndex].itemId

	StartItemTask(varMap)
		ItemAppendBind( varMap, giveitem, x432057_var_ItemTable[ varIndex].broad)
...
--注：这里是技能生效一次的入口
--**********************************
function x432057_ProcActivateEachTick( varMap, varPlayer)
