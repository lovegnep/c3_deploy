...
function x418073_ProcEventEntry( varMap, varPlayer, varBagIdx )
...
function x418073_ProcIsSpellLikeScript( varMap, varPlayer)
	return 1; 
end
...
function x418073_ProcCancelImpacts( varMap, varPlayer )
	return 0; 
end
...
function x418073_ProcConditionCheck( varMap, varPlayer )
...
function x418073_ProcDeplete( varMap, varPlayer )
	return 1;
end
...
function x418073_ProcActivateOnce( varMap, varPlayer, varImpact )
	if(DepletingUsedItem(varMap, varPlayer)) == 1 then
		SendSpecificImpactToUnit(varMap, varPlayer, varPlayer, varPlayer,8318, 0);

	    
		x418073_ProcTopListYanghua(varMap,varPlayer)
...
function x418073_ProcActivateEachTick( varMap, varPlayer)
	return 1; 
end
...
function x418073_ProcTopListYanghua(varMap,varPlayer)
