...
function x418532_ProcActivateOnce( varMap, varPlayer, varImpact )
	...
	ItemAppendBind( varMap, 19010006, 1)	--雕菱锦线包2个
	...
	if ret > 0 then 
		if(DepletingUsedItem(varMap, varPlayer)) == 1 then
			...
			Msg2Player( varMap,varPlayer,"打开龙腾新春大礼包，获得雕菱锦线包2个，还魂丹50个，金卡1000两，豪华将星卡礼盒100个，修理石50个，强效极乐草50个。",8,2) ;
			Msg2Player( varMap,varPlayer,"打开龙腾新春大礼包，获得雕菱锦线包2个，还魂丹50个，金卡1000两，豪华将星卡礼盒100个，修理石50个，强效极乐草50个。",8,3) ;
