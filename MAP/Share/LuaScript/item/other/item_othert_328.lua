x432328_var_FileId = 432328 


function x432328_ProcEventEntry( varMap, varPlayer, varBagIdx )

end

function x432328_ProcIsSpellLikeScript( varMap, varPlayer)
	return 1; 
	
	
end

function x432328_ProcCancelImpacts( varMap, varPlayer )
	return 0; 
end

function x432328_ProcConditionCheck( varMap, varPlayer )
...
function x432328_ProcDeplete( varMap, varPlayer )

	return 1
end

function x432328_ProcActivateOnce( varMap, varPlayer )
	...
	ItemAppendBind( varMap, 12500057, 1 ) --副手图谱·生命奖券1个
...
function x432328_ProcActivateEachTick( varMap, varPlayer)
	return 1; 
end
