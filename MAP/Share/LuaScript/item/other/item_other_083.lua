...
function x418083_ProcEventEntry( varMap, varPlayer, varBagIdx )
...
function x418083_ProcIsSpellLikeScript( varMap, varPlayer)
	return 1; 
end
...
function x418083_ProcCancelImpacts( varMap, varPlayer )
	return 0; 
end
...
function x418083_ProcConditionCheck( varMap, varPlayer )
...
function x418083_ProcDeplete( varMap, varPlayer )
	return 1;
end
...
function x418083_ProcActivateOnce( varMap, varPlayer, varImpact )
	if(DepletingUsedItem(varMap, varPlayer)) == 1 then
		SendSpecificImpactToUnit(varMap, varPlayer, varPlayer, varPlayer,8328, 0);

		
		x418083_ProcTopListYanghua(varMap,varPlayer)
...
function x418083_ProcActivateEachTick( varMap, varPlayer)
	return 1; 
end
...
function x418083_ProcTopListYanghua(varMap,varPlayer)
