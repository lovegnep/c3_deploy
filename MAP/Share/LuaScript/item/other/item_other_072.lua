...
function x418072_ProcEventEntry( varMap, varPlayer, varBagIdx )
...
function x418072_ProcIsSpellLikeScript( varMap, varPlayer)
	return 1; 
end
...
function x418072_ProcCancelImpacts( varMap, varPlayer )
	return 0; 
end
...
function x418072_ProcConditionCheck( varMap, varPlayer )
...
function x418072_ProcDeplete( varMap, varPlayer )
	return 1;
end
...
function x418072_ProcActivateOnce( varMap, varPlayer, varImpact )
	if(DepletingUsedItem(varMap, varPlayer)) == 1 then
		SendSpecificImpactToUnit(varMap, varPlayer, varPlayer, varPlayer,8317, 0);
		
		
		x418072_ProcTopListYanghua(varMap,varPlayer)
...
function x418072_ProcActivateEachTick( varMap, varPlayer)
	return 1; 
end
...
function x418072_ProcTopListYanghua(varMap,varPlayer)
