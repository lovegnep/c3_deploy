...
function x418096_ProcEventEntry( varMap, varPlayer, varBagIdx )
...
function x418096_ProcIsSpellLikeScript( varMap, varPlayer)
	return 1; 
end
...
function x418096_ProcCancelImpacts( varMap, varPlayer )
	return 0; 
end
...
function x418096_ProcConditionCheck( varMap, varPlayer )
...
function x418096_ProcDeplete( varMap, varPlayer )
	return 1;
end
...
function x418096_ProcActivateOnce( varMap, varPlayer, varImpact )
	if(DepletingUsedItem(varMap, varPlayer)) == 1 then
		SendSpecificImpactToUnit(varMap, varPlayer, varPlayer, varPlayer,8341, 0);

		
		x418096_ProcTopListYanghua(varMap,varPlayer)
...
function x418096_ProcActivateEachTick( varMap, varPlayer)
	return 1; 
end
...
function x418096_ProcTopListYanghua(varMap,varPlayer)
