...
function x418092_ProcEventEntry( varMap, varPlayer, varBagIdx )
...
function x418092_ProcIsSpellLikeScript( varMap, varPlayer)
	return 1; 
end
...
function x418092_ProcCancelImpacts( varMap, varPlayer )
	return 0; 
end
...
function x418092_ProcConditionCheck( varMap, varPlayer )
...
function x418092_ProcDeplete( varMap, varPlayer )
	return 1;
end
...
function x418092_ProcActivateOnce( varMap, varPlayer, varImpact )
	if(DepletingUsedItem(varMap, varPlayer)) == 1 then
		SendSpecificImpactToUnit(varMap, varPlayer, varPlayer, varPlayer,8337, 0);

		
		x418092_ProcTopListYanghua(varMap,varPlayer)
...
function x418092_ProcActivateEachTick( varMap, varPlayer)
	return 1; 
end
...
function x418092_ProcTopListYanghua(varMap,varPlayer)
