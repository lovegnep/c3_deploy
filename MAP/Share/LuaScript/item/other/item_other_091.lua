...
function x418091_ProcEventEntry( varMap, varPlayer, varBagIdx )
...
function x418091_ProcIsSpellLikeScript( varMap, varPlayer)
	return 1; 
end
...
function x418091_ProcCancelImpacts( varMap, varPlayer )
	return 0; 
end
...
function x418091_ProcConditionCheck( varMap, varPlayer )
...
function x418091_ProcDeplete( varMap, varPlayer )
	return 1;
end
...
function x418091_ProcActivateOnce( varMap, varPlayer, varImpact )
	if(DepletingUsedItem(varMap, varPlayer)) == 1 then
		SendSpecificImpactToUnit(varMap, varPlayer, varPlayer, varPlayer,8336, 0);

		
		x418091_ProcTopListYanghua(varMap,varPlayer)
...
function x418091_ProcActivateEachTick( varMap, varPlayer)
	return 1; 
end
...
function x418091_ProcTopListYanghua(varMap,varPlayer)
