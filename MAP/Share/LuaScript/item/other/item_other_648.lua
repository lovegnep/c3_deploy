...
x418648_var_FileId 		= 418648 

x418648_var_LevelMin		=	1

x418648_g_ItemID =12271323




function x418648_ProcEventEntry( varMap, varPlayer, varBagIdx )
	if GetItemIDByIndexInBag(varMap, varPlayer, varBagIdx) ~= x418648_g_ItemID then
		return
	end
     ...
     ItemAppendBind( varMap, itemid, 1 )	
	   ...
	   DeliverItemListSendToPlayer(varMap,varPlayer)	
		--GamePlayScriptLog( varMap, varPlayer, 3070+tempmark)
		 Msg2Player(varMap,varPlayer,format("您打开旺运礼盒获得了@item_%d", itemid),4,3)
		end
	else
...
function x418648_ProcIsSpellLikeScript( varMap, varPlayer)
	return 0; 
end
...
function x418648_ProcCancelImpacts( varMap, varPlayer )
	return 0; 
end
...
function x418648_ProcConditionCheck( varMap, varPlayer )
...
function x418648_ProcDeplete( varMap, varPlayer )
...
function x418648_ProcActivateOnce( varMap, varPlayer, varImpact )
...
function x418648_ProcActivateEachTick( varMap, varPlayer)
	return 1; 
end
