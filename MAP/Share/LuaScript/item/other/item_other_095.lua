...
function x418095_ProcEventEntry( varMap, varPlayer, varBagIdx )
...
function x418095_ProcIsSpellLikeScript( varMap, varPlayer)
	return 1; 
end
...
function x418095_ProcCancelImpacts( varMap, varPlayer )
	return 0; 
end
...
function x418095_ProcConditionCheck( varMap, varPlayer )
...
function x418095_ProcDeplete( varMap, varPlayer )
	return 1;
end
...
function x418095_ProcActivateOnce( varMap, varPlayer, varImpact )
	if(DepletingUsedItem(varMap, varPlayer)) == 1 then
		SendSpecificImpactToUnit(varMap, varPlayer, varPlayer, varPlayer,8340, 0);

		
		x418095_ProcTopListYanghua(varMap,varPlayer)
...
function x418095_ProcActivateEachTick( varMap, varPlayer)
	return 1; 
end
...
function x418095_ProcTopListYanghua(varMap,varPlayer)
