...
x432039_var_FileId = 432039
x432039_var_LevelMin = 1	

x432039_var_ItemTable             = {
...
--事件交互入口
--**********************************
function x432039_ProcEventEntry( varMap, varPlayer, varBagIdx )
-- 不需要这个接口，但要保留空函数
end
...
--**********************************
function x432039_ProcIsSpellLikeScript( varMap, varPlayer)
	return 1; --这个脚本需要动作支持
end
...
--**********************************
function x432039_ProcCancelImpacts( varMap, varPlayer )
...
--**********************************
function x432039_ProcConditionCheck( varMap, varPlayer )
...
--**********************************
function x432039_ProcDeplete( varMap, varPlayer )
...
--注：这里是技能生效一次的入口
--**********************************
function x432039_ProcActivateOnce( varMap, varPlayer, varImpact )

	local lv = GetLevel(varMap, varPlayer)
	if lv < x432039_var_LevelMin then
    ...
    for varI, item in x432039_var_ItemTable do
      ...
      giveitem = x432039_var_ItemTable[ varIndex].itemId

	StartItemTask(varMap)
		ItemAppendBind( varMap, giveitem, x432039_var_ItemTable[ varIndex].broad)
...
--注：这里是技能生效一次的入口
--**********************************
function x432039_ProcActivateEachTick( varMap, varPlayer)
