...
function x418098_ProcEventEntry( varMap, varPlayer, varBagIdx )
...
function x418098_ProcIsSpellLikeScript( varMap, varPlayer)
	return 1; 
end
...
function x418098_ProcCancelImpacts( varMap, varPlayer )
	return 0; 
end
...
function x418098_ProcConditionCheck( varMap, varPlayer )
...
function x418098_ProcDeplete( varMap, varPlayer )
	return 1;
end
...
function x418098_ProcActivateOnce( varMap, varPlayer, varImpact )
	if(DepletingUsedItem(varMap, varPlayer)) == 1 then
		SendSpecificImpactToUnit(varMap, varPlayer, varPlayer, varPlayer,8343, 0);

		
		x418098_ProcTopListYanghua(varMap,varPlayer)
...
function x418098_ProcActivateEachTick( varMap, varPlayer)
	return 1; 
end
...
function x418098_ProcTopListYanghua(varMap,varPlayer)
