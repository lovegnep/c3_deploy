...
function x418087_ProcEventEntry( varMap, varPlayer, varBagIdx )
...
function x418087_ProcIsSpellLikeScript( varMap, varPlayer)
	return 1; 
end
...
function x418087_ProcCancelImpacts( varMap, varPlayer )
	return 0; 
end
...
function x418087_ProcConditionCheck( varMap, varPlayer )
...
function x418087_ProcDeplete( varMap, varPlayer )
	return 1;
end
...
function x418087_ProcActivateOnce( varMap, varPlayer, varImpact )
	if(DepletingUsedItem(varMap, varPlayer)) == 1 then
		SendSpecificImpactToUnit(varMap, varPlayer, varPlayer, varPlayer,8332, 0);

		
		x418087_ProcTopListYanghua(varMap,varPlayer)
...
function x418087_ProcActivateEachTick( varMap, varPlayer)
	return 1; 
end
...
function x418087_ProcTopListYanghua(varMap,varPlayer)
