...
x418671_var_FileId 		= 418671 

x418671_var_LevelMin		=	1

x418671_g_ItemID =12030981




function x418671_ProcEventEntry( varMap, varPlayer, varBagIdx )
	...
	if bCplay == 1 then
	  ...
	  StartItemTask(varMap)
   	...
   	DeliverItemListSendToPlayer(varMap,varPlayer)	
	 	...
	 	LuaAllScenceM2Wrold( varMap,"恭喜玩家"..name.."打开每日豪华礼包，获得钻石原石", 5, 1 )
	 	end
		end
	else
...
function x418671_ProcIsSpellLikeScript( varMap, varPlayer)
	return 0; 
end
...
function x418671_ProcCancelImpacts( varMap, varPlayer )
	return 0; 
end
...
function x418671_ProcConditionCheck( varMap, varPlayer )
...
function x418671_ProcDeplete( varMap, varPlayer )
...
function x418671_ProcActivateOnce( varMap, varPlayer, varImpact )
...
function x418671_ProcActivateEachTick( varMap, varPlayer)
	return 1; 
end
