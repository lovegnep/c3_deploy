...
x418031_var_FileId = 418031
x418031_var_ItemList = {}
x418031_var_LevelMin = 65	
...
function x418031_ProcEventEntry( varMap, varPlayer, varBagIdx )
...
function x418031_ProcIsSpellLikeScript( varMap, varPlayer)
	return 1; 
end
...
function x418031_ProcCancelImpacts( varMap, varPlayer )
	return 0; 
end
...
function x418031_ProcConditionCheck( varMap, varPlayer )
...
function x418031_ProcDeplete( varMap, varPlayer )
...
function x418031_ProcActivateOnce( varMap, varPlayer, varImpact )
	
	if GetLevel(varMap, varPlayer)< x418031_var_LevelMin then
...
function x418031_ProcActivateEachTick( varMap, varPlayer)
	return 1; 
end
