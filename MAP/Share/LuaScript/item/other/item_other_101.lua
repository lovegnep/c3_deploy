...
function x418101_ProcEventEntry( varMap, varPlayer, varBagIdx )
...
function x418101_ProcIsSpellLikeScript( varMap, varPlayer)
	return 1; 
end
...
function x418101_ProcCancelImpacts( varMap, varPlayer )
	return 0; 
end
...
function x418101_ProcConditionCheck( varMap, varPlayer )
...
function x418101_ProcDeplete( varMap, varPlayer )
	return 1;
end
...
function x418101_ProcActivateOnce( varMap, varPlayer, varImpact )
	if(DepletingUsedItem(varMap, varPlayer)) == 1 then
		SendSpecificImpactToUnit(varMap, varPlayer, varPlayer, varPlayer,8346, 0);

		
		x418101_ProcTopListYanghua(varMap,varPlayer)
...
function x418101_ProcActivateEachTick( varMap, varPlayer)
	return 1; 
end
...
function x418101_ProcTopListYanghua(varMap,varPlayer)
