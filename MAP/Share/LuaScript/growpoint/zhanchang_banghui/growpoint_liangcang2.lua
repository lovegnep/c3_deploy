...
x300663_var_GatherPointTypeId = 107 		
x300663_var_ItemId = 12010001
x300663_var_BufIndex = 1210


function 	x300663_ProcGpCreate(varMap,varGpType,varX,varY)
	local varBoxId = ItemBoxEnterScene(varX, varY, x300663_var_GatherPointTypeId, varMap, 0, x300663_var_ItemId)
end




function	 x300663_ProcGpOpen(varMap,varPlayer,varTalknpc)
    return x300663_ProcGpOpenItemBox(varMap, varPlayer, varTalknpc, x300663_var_GatherPointTypeId, x300663_var_ItemId)
end




function	 x300663_ProcGpRecycle(varMap,varPlayer,varTalknpc)
	return   x300663_ProcGuildRecycle( varMap, varPlayer, varTalknpc, x300663_var_GatherPointTypeId, x300663_var_ItemId )
end
...
function	x300663_ProcGpProcOver(varMap,varPlayer,varTalknpc)
...
function	x300663_OpenCheck(varMap,varPlayer,AbilityId,AblityLevel)
...
function x300663_ProcGpOpenItemBox( varMap, varPlayer, varTalknpc, varGpType, varNeedItem )
	...
	local guild = GetGuildBattleSceneData_Param(varMap,LD_GUILD_BATTLE_BARN2_GUILD)
...
function x300663_ProcGuildRecycle( varMap, varPlayer, varTalknpc, varGpType, varNeedItem )
	...
	SetGuildBattleSceneData_Param( varMap,LD_GUILD_BATTLE_BARN2_GUILD,GetGuildID(varMap, varPlayer) )

	
	SetGuildBattleSceneData_Param( varMap,LD_GUILD_BATTLE_BARN2_TIME,-1 )

    LuaCallNoclosure( GUILDBATTLE_SCRIPTID,"UpdateSceneDataFlag",varMap,2 )
