...
x310061_var_FileId 					= 	310061                  
x310061_var_QuestId 				= 	8102

x310061_var_QuestKind 				= 	1                       
x310061_var_LevelLess					= 	40                      

x310061_var_QuestName				= 	"【个人】外装黄金藏宝图的秘密"                                        
x310061_var_QuestTarget				= 	"  去#aB#h00CCFF{goto_%d,%d,%d}%s(%d,%d)#aE处使用铁铲挖掘宝藏"      
x310061_var_QuestInfo				= 	"通过阅读这张外装黄金藏宝图，您发现了宝藏的所在。去#aB#h00CCFF{goto_%d,%d,%d}%s(%d,%d)#aE处去挖掘宝藏吧。\n\t注意：当你使用不绑定的藏宝图且有#G江湖请柬#W状态时，能够获得不绑定的奖励道具，否则为绑定。"            
x310061_var_ContinueInfo				= 	""  
x310061_var_QuestCompleted			= 	"\t看来您已经得到@item_12030107,并初步了解外装黄金藏宝图的秘密了吧？现在我给您一条线索，传说按照这条线索追查下去有可能得到传说中的宝藏！传说中的魂魄有可能栖息在地下粮仓，粮仓里深处的五个妖孽趁传说中魂魄虚弱的时候得到了它。打败那些妖孽就有可能得到@item_12030108。"  
x310061_var_QuestHelp				=	"去杂货商人处买一个铁铲，然后去宝藏所在地使用"          

x310061_var_strQuestAbandon         = "您放弃了任务：【个人】外装黄金藏宝图的秘密"


x310061_var_ExtTarget					=	{ {type=20,n=1,target="去杂货商人处买一把铁铲，然后去宝藏所在地使用。"} }



x310061_var_ExpBonus					= 	0                    	
x310061_var_BonusItem					=	{}	

x310061_var_BonusMoney1               = 	0  
x310061_var_BonusMoney2               =   0  
x310061_var_BonusMoney3               =   0  
x310061_var_BonusMoney4               =   0  
x310061_var_BonusMoney5               =   0  
x310061_var_BonusMoney6               =   0  

x310061_var_BonusChoiceItem           =   {}


--DECLARE_QUEST_INFO_STOP--


x310061_MP_TARGET1					= 1   --地图信息
x310061_MP_TARGET2					= 2   --坐标X
x310061_MP_TARGET3					= 3   --坐标Y
x310061_MP_TARGET4					= 4   --挖宝地图ID
x310061_MP_ISCOMPLETE				= 7	  --任务是否完成

x310061_PREVIOUS_QUESTID			= -1		
x310061_NEXT_QUESTID				= 7552		
x310061_NEXT_QUESTSCRIPTID			= 300754	
x310061_QUEST_HUANSHU				= 0			

x310061_var_ItemBonus = {
...
{varId = 12030092, varName = "完整的的冥龙之魂" 			, 	varNum = 1  	,  probability = 3100   },
...
{varId = 11000552, varName = "完美星辰"            		, 	varNum = 1  	,  probability = 4000   },
...
{varId = 11990114, varName = "次生钻石矿"          		, 	varNum = 1  	,  probability = 1370    },
{varId = 11990113, varName = "钻石原石"            		, 	varNum = 1  	,  probability = 700    },
{varId = 11990115, varName = "原生钻石矿"          		, 	varNum = 1  	,  probability = 1200    },
{varId = 11990117, varName = "嘉年华娱乐币"        		, 	varNum = 200  ,  probability = 2000   },
{varId = 12030016, varName = "队伍召集令"          		, 	varNum = 1  	,  probability = 1000   },
...
{varId = 11970022, varName = "强效乱士符"          		, 	varNum = 5  	,  probability = 3000   },
{varId = 12030048, varName = "百两金卡红包"         	, 	varNum = 1  	,  probability = 100 		},
{varId = 12266902, varName = "疾风辕组件"          		, 	varNum = 1  	,  probability = 2000   },
{varId = 11000151, varName = "龙骨解玉钻"          		, 	varNum = 1  	,  probability = 2000   },
{varId = 11000361, varName = "玉佩灵魂印"          		, 	varNum = 1  	,  probability = 2000   },
{varId = 11000368, varName = "宗师级打磨剂"          	, 	varNum = 1  	,  probability = 1000   },
    {varId = 11000369, varName = "传说级打磨剂"          	, 	varNum = 1  	,  probability = 200   },
    {varId = 11000370, varName = "神话级打磨剂"          	, 	varNum = 1  	,  probability = 100   },
{varId = 11000363, varName = "青心钻石"         		 	, 	varNum = 1  	,  probability = 100   },
} 
                              
x310061_var_Bosstable = {  
...
x310061_var_CallerId      = 0
x310061_var_CountryID     = 0
x310061_var_CallerName    = ""

x310061_var_DigRange      = 2

x310061_var_MoneyBuff     = 7046

x310061_var_GemBuff       = 7047

x310061_var_MedicineBuff  = 7048

x310061_var_MonsterBuff   = 7049	




function x310061_ProcEnumEvent( varMap, varPlayer, varTalknpc, varQuest )
...
function x310061_ProcEventEntry(varMap, varPlayer, varTalknpc, varQuest,varExtIdx)	

	local varHaveQuest	= IsHaveQuestNM(varMap, varPlayer, x310061_var_QuestId);
	if(varHaveQuest > 0) then
		local varDone = x310061_CheckSubmit(varMap, varPlayer, varTalknpc);
		if(varDone > 0) then
			if varExtIdx ~= -1 then
				x310061_DispatchCompletedInfo( varMap, varPlayer, varTalknpc ) 
			end
		else
			if varExtIdx ~= -1 then
				x310061_DispatchContinueInfo( varMap, varPlayer, varTalknpc ) 
			end
		end
	else
		x310061_DeliverTalkInfo( varMap, varPlayer, varTalknpc )	
	end
end
...
function x310061_ProcAcceptCheck( varMap, varPlayer, varTalknpc)
	local varHaveQuest	= IsHaveQuestNM(varMap, varPlayer, x310061_var_QuestId);
	if( varHaveQuest > 0) then
		return 0;
	else
...
function x310061_ProcQuestAccept( varMap, varPlayer, varTalknpc, varQuest)
	return 0
end
...
function x310061_ProcQuestAbandon(varMap, varPlayer, varQuest)
	local varHaveQuest	= IsHaveQuestNM(varMap, varPlayer, x310061_var_QuestId);
	if(varHaveQuest > 0) then
		local varQuestIdx = GetQuestIndexByID(varMap, varPlayer, x310061_var_QuestId); 
		DelQuest(varMap, varPlayer, x310061_var_QuestId)

		StartTalkTask( varMap)
		TalkAppendString( varMap, x310061_var_strQuestAbandon)
		StopTalkTask( varMap)
		DeliverTalkTips( varMap, varPlayer)
		Msg2Player( varMap, varPlayer, x310061_var_strQuestAbandon, 8, 2)
	end
end
...
function x310061_CheckSubmit(varMap, varPlayer, varTalknpc)

	local varQuestIdx = GetQuestIndexByID(varMap, varPlayer, x310061_var_QuestId);
	return GetQuestParam(varMap, varPlayer, varQuestIdx, x310061_MP_ISCOMPLETE);
...
function x310061_GetBonus( varMap, varPlayer,varTalknpc, varButtonClick )

	
	if x310061_var_BonusMoney1 > 0 then
	    AddMoney( varMap, varPlayer, 1, x310061_var_BonusMoney1 )
	    Msg2Player(varMap,varPlayer,format("获得银卡#{_MONEY%d}的奖励。", x310061_var_BonusMoney1),4,2)
	end

	
	if x310061_var_BonusMoney2 > 0 then
	    AddMoney( varMap, varPlayer, 0, x310061_var_BonusMoney2 )
	    Msg2Player(varMap,varPlayer,format("获得银币#{_MONEY%d}的奖励。", x310061_var_BonusMoney2),4,2)
	end

	
	if x310061_var_BonusMoney3 > 0 then
	    AddMoney( varMap, varPlayer, 3, x310061_var_BonusMoney3 )
	    Msg2Player(varMap,varPlayer,format("获得金卡#{_MONEY%d}的奖励。", x310061_var_BonusMoney3),4,2)
	end

	
	if x310061_var_BonusMoney4 > 0 then
		local varRongYu = GetRongYu( varMap, varPlayer )
		varRongYu = varRongYu + x310061_var_BonusMoney4
		SetRongYu( varMap, varPlayer, varRongYu )
		Msg2Player(varMap,varPlayer,format("获得江湖声望%d的奖励。", x310061_var_BonusMoney4),4,2)
	end

	
	if x310061_var_BonusMoney5 > 0 then
		local varShengWang = GetShengWang( varMap, varPlayer )
		varShengWang = varShengWang + x310061_var_BonusMoney5
		SetShengWang( varMap, varPlayer, varShengWang )
		Msg2Player(varMap,varPlayer,format("获得朝廷声望%d的奖励。", x310061_var_BonusMoney5),4,2)
	end

	
	if x310061_var_BonusMoney6 > 0 then
		AddHonor(varMap,varPlayer,x310061_var_BonusMoney6)
		Msg2Player(varMap,varPlayer,format("获得荣誉值%d的奖励。", x310061_var_BonusMoney6),4,2)
	end

 	
	for varI, item in x310061_var_BonusItem do
	...
	for varI, item in x310061_var_BonusChoiceItem do
...
function x310061_ProcQuestSubmit(varMap, varPlayer, varTalknpc, varRadioSelected, varQuest)
	...
	if varHaveQuest > 0 then
		...
		local varQuestIdx = GetQuestIndexByID(varMap, varPlayer, x310061_var_QuestId)
		local completed = GetQuestParam(varMap, varPlayer, varQuestIdx, x310061_MP_ISCOMPLETE)

		if completed == 1 then
			local result = x310061_CheckPlayerBagFull(varMap,varPlayer)
			if result == 1 then
		    	x310061_GetBonus( varMap,varPlayer,varTalknpc,varRadioSelected )
		    	DelQuest(varMap, varPlayer, x310061_var_QuestId)
...
function x310061_CheckPlayerBagFull( varMap ,varPlayer )
	...
	StartItemTask(varMap)
	for j, item in x310061_var_BonusItem do
		ItemAppend( varMap, item.item, item.n )
    end
	...
	if bAdd == 0 then
		...
		for j, item in x310061_var_BonusChoiceItem do
	        StartItemTask(varMap)
			ItemAppend( varMap, item.item, item.n )
			local varRet = StopItemTask(varMap,varPlayer)
			if varRet <= 0 then
...
function x310061_DeliverTalkInfo( varMap, varPlayer, varTalknpc )

	StartTalkTask(varMap)

		
		TalkAppendString(varMap,"#Y"..x310061_var_QuestName)
		TalkAppendString(varMap,x310061_var_QuestInfo)
		TalkAppendString(varMap," ")

		
		TalkAppendString( varMap,"#Y任务目标：")
		TalkAppendString( varMap,x310061_var_QuestTarget)
		TalkAppendString( varMap," ")

		
		if x310061_var_QuestHelp ~= "" then

			TalkAppendString(varMap,"#Y任务提示：")
			TalkAppendString(varMap,x310061_var_QuestHelp )
			TalkAppendString(varMap," ")
		end
		...
		if x310061_var_ExpBonus> 0 then
			AddQuestExpBonus(varMap, x310061_var_ExpBonus )
		end

		
		if x310061_var_BonusMoney1 > 0 then
			AddQuestMoneyBonus1(varMap, x310061_var_BonusMoney1 )
		end

		
		if x310061_var_BonusMoney2 > 0 then
			AddQuestMoneyBonus2(varMap, x310061_var_BonusMoney2 )
		end
		
		if x310061_var_BonusMoney3 > 0 then
			AddQuestMoneyBonus3(varMap, x310061_var_BonusMoney3 )
		end

		
		if x310061_var_BonusMoney4 > 0 then
			AddQuestMoneyBonus4(varMap, x310061_var_BonusMoney4 )
		end

		
		if x310061_var_BonusMoney5 > 0 then
			AddQuestMoneyBonus5(varMap, x310061_var_BonusMoney5 )
		end

		
		if x310061_var_BonusMoney6 > 0 then
			AddQuestMoneyBonus6(varMap, x310061_var_BonusMoney6 )
		end
	...
	StopTalkTask()
	DeliverTalkInfoNM(varMap, varPlayer, varTalknpc, x310061_var_FileId, x310061_var_QuestId);
end




function x310061_ProcDigbyShovel( varMap, varPlayer)
    ...
    if IsHaveQuestNM( varMap, varPlayer, x310061_var_QuestId) == 0 then       
        return 0
    else
        local varQuestIdx = GetQuestIndexByID( varMap, varPlayer, x310061_var_QuestId)
        local ts = GetQuestParam( varMap, varPlayer, varQuestIdx, x310061_MP_TARGET4)
        if ts ~= varMap then
    		StartTalkTask( varMap)
    		TalkAppendString( varMap, "外装黄金藏宝图任务挖掘场景不对，您白忙活一场" )
    		StopTalkTask( varMap)
    		DeliverTalkTips( varMap, varPlayer)
            Msg2Player( varMap, varPlayer, "外装黄金藏宝图任务挖掘场景不对，您白忙活一场", 8, 2)
            return 0
        end
        local varX = GetQuestParam( varMap, varPlayer, varQuestIdx, x310061_MP_TARGET2)
        local z = GetQuestParam( varMap, varPlayer, varQuestIdx, x310061_MP_TARGET3)
        local curX, curZ = GetWorldPos( varMap, varPlayer)
        curX = abs( varX - curX)
        curZ = abs( z - curZ)
        if curX > x310061_var_DigRange or curZ > x310061_var_DigRange then
    		StartTalkTask( varMap)
    		TalkAppendString( varMap, "外装黄金藏宝图任务挖掘座标不对，您白忙活一场" )
    		StopTalkTask( varMap)
    		DeliverTalkTips( varMap, varPlayer)
            Msg2Player( varMap, varPlayer, "外装黄金藏宝图任务挖掘座标不对，您白忙活一场", 8, 2)
            return 0
        end
        ...
        if varprobability < 91571 then
 				...
 				-- 先求总概率
				local totalProb = 0
				for i, iter in x310061_var_ItemBonus do
            ...
            if item ~= nil then
                ...
                StartTalkTask( varMap)
                local strTemp = format( "在外装黄金藏宝图的指引下，您得到了#R%d个#{_ITEM%d}#cffcf00，恭喜恭喜。", item.varNum,item.varId)
                ...
                for i,j in x310061_var_notifytable do
                    if item.varId == j then
                        local varName = GetName( varMap, varPlayer)
                        local msg1 = format("#cffcf00恭喜恭喜！玩家"..varName.."使用外装黄金藏宝图寻宝时获得了#R%d个#{_ITEM%d}#cffcf00#cffcf00，真是好运气啊！",item.varNum,item.varId)
                        local msg  = format(varName.."使用外装黄金藏宝图寻宝时获得了#R%d个#{_ITEM%d}#cffcf00#cffcf00！",item.varNum,item.varId)
          ...
          elseif varprobability >= 91571 and varprobability <= 91900 then
          	i = random( 1, getn( x310061_var_Bosstable) )
          	local item = x310061_var_Bosstable
          	local varX, z = GetWorldPos( varMap, varPlayer)
          	local varObj = CreateMonster( varMap, item[i].mon_ID, varX, z, item[i].ai, item[i].aiscript, -1, -1, 21, 60*60*1000, 0, "", item[i].title)
						local varName = GetName( varMap, varPlayer)
						local sceneName = GetSceneInfo(varMap,"NAME")
						local msg1 = "#e010101#cFF7903玩家#G"..varName.."#e010101#cFF7903在使用外装黄金藏宝图寻宝的过程惊动了沉睡的十八魔君"..item[i].title.."，现在妖兽在"..sceneName.."#e010101#cFF7903附近游荡，请大家快快前往消灭。"
						LuaAllScenceM2Wrold(varMap, msg1, CHAT_PLANE_SCROLL, 1)
						LuaAllScenceM2Wrold(varMap, msg1, CHAT_LEFTDOWN, 1)
					elseif varprobability >= 91901 and varprobability <= 92000 then
						...
						local msg1 = "#e010101#cFF7903玩家#G"..varName.."#e010101#cFF7903在使用外装黄金藏宝图寻宝的过程惊动了恐怖的暗·海都大王，现在恐怖的暗·海都大王在"..sceneName.."#e010101#cFF7903附近游荡，请大家快快前往消灭。"
						LuaAllScenceM2Wrold(varMap, msg1, CHAT_PLANE_SCROLL, 1)
						LuaAllScenceM2Wrold(varMap, msg1, CHAT_LEFTDOWN, 1)
					elseif varprobability >= 92001 and varprobability <= 97000 then
						...
						local msg1 = "#cffcf00恭喜恭喜！玩家"..varName.."使用外装黄金藏宝图寻宝时获得了#R200两银卡#cffcf00，真是好运气啊！"
					...
					elseif varprobability >= 97001 and varprobability <= 99000 then
						...
						AddMoney( varMap, varPlayer,1, money )
						local varStr = format( "获得#R银卡#{_MONEY%d}#o的奖励", money)
						local msg1	 = "#cffcf00恭喜恭喜！玩家"..varName.."使用外装黄金藏宝图寻宝时获得了#R500两银卡#cffcf00，真是好运气啊！"
						Msg2Player( varMap, varPlayer, varStr, 8, 2)
						Msg2Player( varMap, varPlayer, varStr, 8, 3)
						LuaAllScenceM2Wrold(varMap, msg1, CHAT_PLANE_SCROLL, 1)
						LuaAllScenceM2Wrold(varMap, msg1, CHAT_LEFTDOWN, 1)
					elseif varprobability >= 99001 and varprobability <= 100000 then
						...
						AddMoney( varMap, varPlayer,1, money )
						local varStr = format( "获得#R银卡#{_MONEY%d}#o的奖励", money)
						local msg1	 = "#cffcf00恭喜恭喜！玩家"..varName.."使用外装黄金藏宝图寻宝时获得了#R1锭银卡#cffcf00，真是好运气啊！"
						Msg2Player( varMap, varPlayer, varStr, 8, 2)
						Msg2Player( varMap, varPlayer, varStr, 8, 3)
						LuaAllScenceM2Wrold(varMap, msg1, CHAT_PLANE_SCROLL, 1)
						LuaAllScenceM2Wrold(varMap, msg1, CHAT_LEFTDOWN, 1)
 					...
 					DelQuest( varMap, varPlayer, x310061_var_QuestId)
 				 -- 提示任务完成
 				 Msg2Player( varMap, varPlayer, "您完成了："..x310061_var_QuestName, 8, 2)
 				 Msg2Player( varMap, varPlayer, "您完成了："..x310061_var_QuestName, 8, 3)
 				 -- 写日志
...
function x310061_CallBoss( varMap, varPlayer)
    local monsters = {}
    local varCount = 1
    ...
    for varI, item in x310061_var_MonsterTable do
    ...
    for varI, item in x310061_var_MonsterLive do
    ...
    local varX, z = GetWorldPos( varMap, varPlayer)
    local mapName = ""
    CreateMonster( varMap, monsters[ varI].bossId, varX + random( 1, 3), z + random( 1, 3), 1, -1, x310061_var_FileId, -1, 21, 30*60*1000)
    
    for varI, item in x310061_var_MonsterLive do
        if item.varMap == varMap then
            x310061_var_MonsterLive[ varI].live = 1
...
function x310061_ProcDie( varMap, varPlayer, varKiller)
    ...
    for varI, item in x310061_var_MonsterLive do
        if item.varMap == varMap then
            x310061_var_MonsterLive[ varI].live = 0
        end
    end
...
function x310061_DispatchContinueInfo( varMap, varPlayer, varTalknpc )
end




function x310061_DispatchCompletedInfo( varMap, varPlayer, varTalknpc )
end




function x310061_ProcQuestObjectKilled(varMap, varPlayer, varObjData ,varObj, varQuest )
end




function x310061_ProcQuestItemChanged( varMap, varPlayer, varItemData, varQuest )
end




function x310061_ProcQuestAttach( varMap, varPlayer, varTalknpc, varTalkNpcGUID, varQuestIdx, varQuest )
end




function x310061_ProcQuestLogRefresh( varMap, varPlayer, varQuest)
    local varQuestIdx = GetQuestIndexByID( varMap, varPlayer, x310061_var_QuestId)
    local mapID = GetQuestParam( varMap, varPlayer, varQuestIdx, x310061_MP_TARGET1)
    local varTalknpc = GetQuestParam( varMap, varPlayer, varQuestIdx, x310061_MP_TARGET4)
    local varX = GetQuestParam( varMap, varPlayer, varQuestIdx, x310061_MP_TARGET2)
    local z = GetQuestParam( varMap, varPlayer, varQuestIdx, x310061_MP_TARGET3)
    local strMapName = ""
	...
	StartTalkTask(varMap)
        AddQuestLogCustomText( varMap,
                                "",                             
                                x310061_var_QuestName,             
                                format( x310061_var_QuestTarget, varTalknpc, varX, z,strMapName,varX,z),
                                "无",                             
                                x310061_var_QuestHelp,
                                format( x310061_var_QuestInfo, varTalknpc, varX, z,strMapName,varX,z),
                                "" )
...
function x310061_ProcForceAddQuest( varMap, varPlayer, varTalknpc, varQuest)
	if( varQuest ~= x310061_var_QuestId) then
		return 0;
	end

	
	if(x310061_ProcAcceptCheck( varMap, varPlayer, -1 ) ~= 1) then
		return 0;
	end
	local varRet = AddQuest( varMap, varPlayer, x310061_var_QuestId, x310061_var_FileId, 0, 0, 0, 0)
	if(varRet == 0) then
		StartTalkTask(varMap)
        ...
        StartTalkTask( varMap)
        TalkAppendString( varMap, "您获得了任务：【个人】外装黄金藏宝图的秘密" )
        StopTalkTask( varMap)
        DeliverTalkTips( varMap, varPlayer)
        Msg2Player( varMap, varPlayer, "您获得了任务：【个人】外装黄金藏宝图的秘密", 8, 2)
	end

		local guo = GetCurCountry(varMap,varPlayer)
		if guo ==0 then
	    
	    local size = getn( x310061_var_QuestTargetTable0)
	    ...
	    local varQuestIdx = GetQuestIndexByID(varMap, varPlayer, x310061_var_QuestId)
	    SetQuestByIndex( varMap, varPlayer, varQuestIdx, x310061_MP_TARGET1, x310061_var_QuestTargetTable0[ varI].varMap)
	    SetQuestByIndex( varMap, varPlayer, varQuestIdx, x310061_MP_TARGET2, x310061_var_QuestTargetTable0[ varI].posX)
	    SetQuestByIndex( varMap, varPlayer, varQuestIdx, x310061_MP_TARGET3, x310061_var_QuestTargetTable0[ varI].posZ)
	    local mapid = GetCurCountry( varMap, varPlayer) * 100 + x310061_var_QuestTargetTable0[ varI].varMap + 50
	    if x310061_var_QuestTargetTable0[ varI].varMap == 2 then
	        mapid = 0
	    elseif x310061_var_QuestTargetTable0[ varI].varMap == 3 then
	        mapid = 15
	    elseif x310061_var_QuestTargetTable0[ varI].varMap == 5 then
	        mapid = 5	        
	    elseif x310061_var_QuestTargetTable0[ varI].varMap == 8 then
	        mapid = 8		      
	    elseif x310061_var_QuestTargetTable0[ varI].varMap == 11 then
	        mapid = 11	
	    elseif x310061_var_QuestTargetTable0[ varI].varMap == 17 then
	        mapid = 17	     
	    elseif x310061_var_QuestTargetTable0[ varI].varMap == 20 then
	        mapid = 20	        
	    elseif x310061_var_QuestTargetTable0[ varI].varMap == 23 then
	        mapid = 23		     
	    end
	    SetQuestByIndex( varMap, varPlayer, varQuestIdx, x310061_MP_TARGET4, mapid)
	    SetQuestByIndex( varMap, varPlayer, varQuestIdx, x310061_MP_ISCOMPLETE, 0)
	    ...
	    local size = getn( x310061_var_QuestTargetTable1)
	    local varI = random( 1, size)
	    ...
	    local varQuestIdx = GetQuestIndexByID(varMap, varPlayer, x310061_var_QuestId)
	    SetQuestByIndex( varMap, varPlayer, varQuestIdx, x310061_MP_TARGET1, x310061_var_QuestTargetTable1[ varI].varMap)
	    SetQuestByIndex( varMap, varPlayer, varQuestIdx, x310061_MP_TARGET2, x310061_var_QuestTargetTable1[ varI].posX)
	    SetQuestByIndex( varMap, varPlayer, varQuestIdx, x310061_MP_TARGET3, x310061_var_QuestTargetTable1[ varI].posZ)
	    local mapid= GetCurCountry( varMap, varPlayer) * 100 + x310061_var_QuestTargetTable1[ varI].varMap + 50
	    if x310061_var_QuestTargetTable1[ varI].varMap == 2 then
	        mapid = 0
	    elseif x310061_var_QuestTargetTable1[ varI].varMap == 3 then
	        mapid = 15
	    elseif x310061_var_QuestTargetTable1[ varI].varMap == 5 then
	        mapid = 5	        
	    elseif x310061_var_QuestTargetTable1[ varI].varMap == 8 then
	        mapid = 8		      
	    elseif x310061_var_QuestTargetTable1[ varI].varMap == 11 then
	        mapid = 11	
	    elseif x310061_var_QuestTargetTable1[ varI].varMap == 17 then
	        mapid = 17	     
	    elseif x310061_var_QuestTargetTable1[ varI].varMap == 20 then
	        mapid = 20	        
	    elseif x310061_var_QuestTargetTable1[ varI].varMap == 23 then
	        mapid = 23		        
	    end
	    SetQuestByIndex( varMap, varPlayer, varQuestIdx, x310061_MP_TARGET4, mapid)
	    SetQuestByIndex( varMap, varPlayer, varQuestIdx, x310061_MP_ISCOMPLETE, 0)
	    ...
	    local size = getn( x310061_var_QuestTargetTable2)
	    local varI = random( 1, size)
	    ...
	    local varQuestIdx = GetQuestIndexByID(varMap, varPlayer, x310061_var_QuestId)
	    SetQuestByIndex( varMap, varPlayer, varQuestIdx, x310061_MP_TARGET1, x310061_var_QuestTargetTable2[ varI].varMap)
	    SetQuestByIndex( varMap, varPlayer, varQuestIdx, x310061_MP_TARGET2, x310061_var_QuestTargetTable2[ varI].posX)
	    SetQuestByIndex( varMap, varPlayer, varQuestIdx, x310061_MP_TARGET3, x310061_var_QuestTargetTable2[ varI].posZ)
	    local mapid = GetCurCountry( varMap, varPlayer) * 100 + x310061_var_QuestTargetTable2[ varI].varMap + 50
	    if x310061_var_QuestTargetTable2[ varI].varMap == 2 then
	        mapid = 0
	    elseif x310061_var_QuestTargetTable2[ varI].varMap == 3 then
	        mapid = 15
	    elseif x310061_var_QuestTargetTable2[ varI].varMap == 5 then
	        mapid = 5	        
	    elseif x310061_var_QuestTargetTable2[ varI].varMap == 8 then
	        mapid = 8		      
	    elseif x310061_var_QuestTargetTable2[ varI].varMap == 11 then
	        mapid = 11	
	    elseif x310061_var_QuestTargetTable2[ varI].varMap == 17 then
	        mapid = 17	     
	    elseif x310061_var_QuestTargetTable2[ varI].varMap == 20 then
	        mapid = 20	        
	    elseif x310061_var_QuestTargetTable2[ varI].varMap == 23 then
	        mapid = 23		
	    end
	    SetQuestByIndex( varMap, varPlayer, varQuestIdx, x310061_MP_TARGET4, mapid)
	    SetQuestByIndex( varMap, varPlayer, varQuestIdx, x310061_MP_ISCOMPLETE, 0)
	    ...
	    local size = getn( x310061_var_QuestTargetTable3)
	    local varI = random( 1, size)
	    ...
	    local varQuestIdx = GetQuestIndexByID(varMap, varPlayer, x310061_var_QuestId)
	    SetQuestByIndex( varMap, varPlayer, varQuestIdx, x310061_MP_TARGET1, x310061_var_QuestTargetTable3[ varI].varMap)
	    SetQuestByIndex( varMap, varPlayer, varQuestIdx, x310061_MP_TARGET2, x310061_var_QuestTargetTable3[ varI].posX)
	    SetQuestByIndex( varMap, varPlayer, varQuestIdx, x310061_MP_TARGET3, x310061_var_QuestTargetTable3[ varI].posZ)
	    local mapid = GetCurCountry( varMap, varPlayer) * 100 + x310061_var_QuestTargetTable3[ varI].varMap + 50
	    if x310061_var_QuestTargetTable3[ varI].varMap == 2 then
	        mapid = 0
	    elseif x310061_var_QuestTargetTable3[ varI].varMap == 3 then
	        mapid = 15
	    elseif x310061_var_QuestTargetTable3[ varI].varMap == 5 then
	        mapid = 5	        
	    elseif x310061_var_QuestTargetTable3[ varI].varMap == 8 then
	        mapid = 8		      
	    elseif x310061_var_QuestTargetTable3[ varI].varMap == 11 then
	        mapid = 11	
	    elseif x310061_var_QuestTargetTable3[ varI].varMap == 17 then
	        mapid = 17	     
	    elseif x310061_var_QuestTargetTable3[ varI].varMap == 20 then
	        mapid = 20	        
	    elseif x310061_var_QuestTargetTable3[ varI].varMap == 23 then
	        mapid = 23		        
	    end
	    SetQuestByIndex( varMap, varPlayer, varQuestIdx, x310061_MP_TARGET4, mapid)
	    SetQuestByIndex( varMap, varPlayer, varQuestIdx, x310061_MP_ISCOMPLETE, 0)
...
function x310061_ProcCreaterGetBonus(varMap,guid,questdata)
