...
{varId = 11030501, varName = "熔火石" 					, 	varNum = 10  ,	 probability = 5000 	},
{varId = 11030405, varName = "七步蛇" 					, 	varNum = 10  ,	 probability = 5000 	},
{varId = 11020501, varName = "草本精华" 					, 	varNum = 10  ,	 probability = 5000 	},
...
{varId = 12050325, varName = "生命源龙降世符"          		, 	varNum = 1  ,  probability = 100      },
    ...
    if IsHaveQuestNM( varMap, varPlayer, x300337_var_QuestId) == 0 then       
		...
		if varprobability < 91571 then
				...
				if pvar1 <= 10 then
 				...
 				local buff2 =	9012
 				local item = nil
 				 varprobability = random (1, 100000)
