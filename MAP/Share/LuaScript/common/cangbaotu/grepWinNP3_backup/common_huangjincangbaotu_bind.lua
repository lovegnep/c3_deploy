...
{varId = 12050284, varName = "熊猫降世符"          		, 	varNum = 1  ,  probability = 99      },
{varId = 12050280, varName = "羊驼降世符"          		, 	varNum = 1  ,  probability = 100     },
{varId = 12050351, varName = "毛驴降世符"          		, 	varNum = 1  ,  probability = 100      },
{varId = 12050353, varName = "天龙降世符"          		, 	varNum = 1  ,  probability = 100      },
{varId = 12050352, varName = "青螭降世符"          		, 	varNum = 1  ,  probability = 100      },
        ...
        if curX > x300338_var_DigRange or curZ > x300338_var_DigRange then
            ...
            return 0
				...
				for i, iter in x300338_var_ItemBonus do
 				...
 				local varprobability = random (1, totalProb)
 					for i, iter in x300338_var_ItemBonus do
