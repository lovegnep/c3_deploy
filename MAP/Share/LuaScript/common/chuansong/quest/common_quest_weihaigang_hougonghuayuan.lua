...
x490410_var_FileId 					= 490410
x490410_var_QuestName				= "后花园传送"
x490410_var_TransTypeId				= {1124,2124,3124,4124}
x490410_var_TransPoint				=  {1216,2216,3216,4216}
...
function x490410_ProcEnumEvent(varMap, varPlayer, varTalknpc, varQuest)

	TalkAppendButton(varMap, x490410_var_FileId, x490410_var_QuestName,15);
	
end

function x490410_ProcEventEntry(varMap, varPlayer, varTalknpc)
...
--	end
	...
	local varCountry = GetCurCountry(varMap, varPlayer)
		...
		if varCountry == 0 then
			DeliverTransferType(varMap, varPlayer, varTalknpc, x490410_var_TransTypeId[1], x490410_var_TransPoint[1])
		elseif varCountry == 1 then
			DeliverTransferType(varMap, varPlayer, varTalknpc, x490410_var_TransTypeId[2], x490410_var_TransPoint[2])
		elseif varCountry == 2 then	
			DeliverTransferType(varMap, varPlayer, varTalknpc, x490410_var_TransTypeId[3], x490410_var_TransPoint[3])
		elseif varCountry == 3 then
			DeliverTransferType(varMap, varPlayer, varTalknpc, x490410_var_TransTypeId[4], x490410_var_TransPoint[4])
		end	
...
function x490410_ProcAcceptCheck(varMap, varPlayer, varTalknpc)
...
function x490410_ProcAccept(varMap, varPlayer, varTalknpc)
