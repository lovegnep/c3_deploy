...
x490423_var_FileId 					= 490423
x490423_var_QuestName				= "后花园传送"
x490423_var_TransTypeId				= {1127,2127,3127,4127}
x490423_var_TransPoint				=  {1222,2222,3222,4222}
...
function x490423_ProcEnumEvent(varMap, varPlayer, varTalknpc, varQuest)

	TalkAppendButton(varMap, x490423_var_FileId, x490423_var_QuestName,15);
	
end

function x490423_ProcEventEntry(varMap, varPlayer, varTalknpc)
...
--	end
	...
	local varCountry = GetCurCountry(varMap, varPlayer)
		...
		if varCountry == 0 then
			DeliverTransferType(varMap, varPlayer, varTalknpc, x490423_var_TransTypeId[1], x490423_var_TransPoint[1])
		elseif varCountry == 1 then
			DeliverTransferType(varMap, varPlayer, varTalknpc, x490423_var_TransTypeId[2], x490423_var_TransPoint[2])
		elseif varCountry == 2 then	
			DeliverTransferType(varMap, varPlayer, varTalknpc, x490423_var_TransTypeId[3], x490423_var_TransPoint[3])
		elseif varCountry == 3 then
			DeliverTransferType(varMap, varPlayer, varTalknpc, x490423_var_TransTypeId[4], x490423_var_TransPoint[4])
		end	
...
function x490423_ProcAcceptCheck(varMap, varPlayer, varTalknpc)
...
function x490423_ProcAccept(varMap, varPlayer, varTalknpc)
