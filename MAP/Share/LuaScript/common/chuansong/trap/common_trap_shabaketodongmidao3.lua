...
x490490_var_FileId = 490490
x490490_var_TransPosloulan  ="shabaketodongmidao3"
x490490_var_TransPoslaiyin  ="shabaketodongmidao3"
x490490_var_TransPoskunlun  ="shabaketodongmidao3"
x490490_var_TransPosdunhuang="shabaketodongmidao3"


function x490490_ProcAreaEntered( varMap, varPlayer, varArea, varQuest )
	...
	if selfType == 9 then	
		...
		if busType == 1 then 
			...
			for	varI = 0, memberCount - 1 do
				...
				x490490_TransToPosition(varMap, varObj)
			end
	...
	x490490_TransToPosition(varMap, varPlayer)
end

function x490490_TransToPosition(varMap, varPlayer)

	local guo = GetCurCountry(varMap,varPlayer)
	
	if guo == 0 then
		LuaCallNoclosure(COMMON_CHUANSONG_NORMAL, "TransferToWorld",varMap,varPlayer,x490490_var_TransPosloulan)
		
		elseif guo == 1 then
		LuaCallNoclosure(COMMON_CHUANSONG_NORMAL, "TransferToWorld",varMap,varPlayer,x490490_var_TransPoslaiyin)
		
		elseif guo == 2 then
		LuaCallNoclosure(COMMON_CHUANSONG_NORMAL, "TransferToWorld",varMap,varPlayer,x490490_var_TransPoskunlun)
		
		elseif guo == 3 then
		LuaCallNoclosure(COMMON_CHUANSONG_NORMAL, "TransferToWorld",varMap,varPlayer,x490490_var_TransPosdunhuang)
	
	end
end


function x490490_ProcMapTimerTick( varMap, monsterobjid )

end


function x490490_ProcAreaLeaved( varMap, monsterobjid, varScript, varQuest )

end


function x490490_ProcEventEntry( varMap, monsterobjid )
