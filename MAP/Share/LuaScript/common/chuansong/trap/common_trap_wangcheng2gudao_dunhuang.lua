...
x300202_var_FileId = 300202
x300202_var_TransPosloulan  ="wangcheng2gudaodunhuang"
x300202_var_TransPoslaiyin  ="wangcheng2gudaodunhuang"
x300202_var_TransPoskunlun  ="wangcheng2gudaodunhuang"
x300202_var_TransPosdunhuang="wangcheng2gudaodunhuang"



function x300202_ProcAreaEntered( varMap, varPlayer, varArea, varQuest )
	...
	if selfType == 9 then	
		...
		if busType == 1 then 
			...
			for	varI = 0, memberCount - 1 do
				...
				x300202_TransToPosition(varMap, varObj)
			end
	...
	x300202_TransToPosition(varMap, varPlayer)
end


function x300202_TransToPosition(varMap, varPlayer)

	local guo = GetCurCountry(varMap,varPlayer)
	
	if guo == 0 then
		LuaCallNoclosure(COMMON_CHUANSONG_NORMAL, "TransferToWorld",varMap,varPlayer,x300202_var_TransPosloulan)
		
		elseif guo == 1 then
		LuaCallNoclosure(COMMON_CHUANSONG_NORMAL, "TransferToWorld",varMap,varPlayer,x300202_var_TransPoslaiyin)
		
		elseif guo == 2 then
		LuaCallNoclosure(COMMON_CHUANSONG_NORMAL, "TransferToWorld",varMap,varPlayer,x300202_var_TransPoskunlun)
		
		elseif guo == 3 then
		LuaCallNoclosure(COMMON_CHUANSONG_NORMAL, "TransferToWorld",varMap,varPlayer,x300202_var_TransPosdunhuang)
	
	end
end


function x300202_ProcMapTimerTick( varMap, monsterobjid )

end


function x300202_ProcAreaLeaved( varMap, monsterobjid, varScript, varQuest )

end


function x300202_ProcEventEntry( varMap, monsterobjid )
