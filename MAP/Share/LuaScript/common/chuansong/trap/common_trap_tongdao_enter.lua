...
x300479_var_FileId = 300479
x300479_var_TransPosLou="loulanbianjingenter2xiaoshuidao"
x300479_var_TransPosLai="laiyinbianjingenter2xiaoshuidao"
x300479_var_TransPosKun="kunlunbianjingenter2xiaoshuidao"
x300479_var_TransPosDun="dunhuangbianjingenter2xiaoshuidao"
x300479_var_Notice = "您的等级还不足#R20级#Y，无法前往秘道！"


function x300479_ProcAreaEntered( varMap, varPlayer, varArea, varQuest )
	...
	if selfType == 1 then 
			...
			if nLevel < 20 then 
					Msg2Player(varMap,varPlayer,"#Y"..x300479_var_Notice.."#W",4,3)
					return
			end
	end
	...
	if selfType == 9 then	
		...
		if busType == 1 then 
			...
			for	varI = 0, memberCount - 1 do
				...
				x300479_TransToPosition(varMap, varObj)
			end
	...
	x300479_TransToPosition(varMap, varPlayer)
end

function x300479_TransToPosition(varMap, varPlayer)
	if varMap == 51 then
		LuaCallNoclosure(COMMON_CHUANSONG_NORMAL, "TransferToWorld",varMap,varPlayer,x300479_var_TransPosLou)
	elseif varMap == 151 then
		LuaCallNoclosure(COMMON_CHUANSONG_NORMAL, "TransferToWorld",varMap,varPlayer,x300479_var_TransPosLai)
	elseif varMap == 251 then
		LuaCallNoclosure(COMMON_CHUANSONG_NORMAL, "TransferToWorld",varMap,varPlayer,x300479_var_TransPosKun)
	elseif varMap == 351 then
		LuaCallNoclosure(COMMON_CHUANSONG_NORMAL, "TransferToWorld",varMap,varPlayer,x300479_var_TransPosDun)
	end
end
...
function x300479_ProcAreaLeaved( varMap, monsterobjid, varScript, varQuest )

end


function x300479_ProcEventEntry( varMap, monsterobjid )
