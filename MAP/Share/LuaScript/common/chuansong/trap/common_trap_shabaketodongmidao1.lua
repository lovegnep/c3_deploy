...
x490486_var_FileId = 490486
x490486_var_TransPosloulan  ="shabaketodongmidao1"
x490486_var_TransPoslaiyin  ="shabaketodongmidao1"
x490486_var_TransPoskunlun  ="shabaketodongmidao1"
x490486_var_TransPosdunhuang="shabaketodongmidao1"


function x490486_ProcAreaEntered( varMap, varPlayer, varArea, varQuest )
	...
	if selfType == 9 then	
		...
		if busType == 1 then 
			...
			for	varI = 0, memberCount - 1 do
				...
				x490486_TransToPosition(varMap, varObj)
			end
	...
	x490486_TransToPosition(varMap, varPlayer)
end

function x490486_TransToPosition(varMap, varPlayer)

	local guo = GetCurCountry(varMap,varPlayer)
	
	if guo == 0 then
		LuaCallNoclosure(COMMON_CHUANSONG_NORMAL, "TransferToWorld",varMap,varPlayer,x490486_var_TransPosloulan)
		
		elseif guo == 1 then
		LuaCallNoclosure(COMMON_CHUANSONG_NORMAL, "TransferToWorld",varMap,varPlayer,x490486_var_TransPoslaiyin)
		
		elseif guo == 2 then
		LuaCallNoclosure(COMMON_CHUANSONG_NORMAL, "TransferToWorld",varMap,varPlayer,x490486_var_TransPoskunlun)
		
		elseif guo == 3 then
		LuaCallNoclosure(COMMON_CHUANSONG_NORMAL, "TransferToWorld",varMap,varPlayer,x490486_var_TransPosdunhuang)
	
	end
end


function x490486_ProcMapTimerTick( varMap, monsterobjid )

end


function x490486_ProcAreaLeaved( varMap, monsterobjid, varScript, varQuest )

end


function x490486_ProcEventEntry( varMap, monsterobjid )
