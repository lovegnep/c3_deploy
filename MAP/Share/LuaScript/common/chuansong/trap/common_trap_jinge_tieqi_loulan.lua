...
x300465_var_FileId = 300465
x300465_var_TransPosloulan=		"jinge2tieqiloulan"
x300465_var_TransPoslaiyin=		"jinge2tieqilanyin"
x300465_var_TransPoskunlun=		"jinge2tieqikunlun"
x300465_var_TransPosdunhuang=	"jinge2tieqidunhuang"



function x300465_ProcAreaEntered( varMap, varPlayer, varArea, varQuest )
	...
	if selfType == 9 then	
		...
		if busType == 1 then 
			...
			for	varI = 0, memberCount - 1 do
				...
				x300465_TransToPosition(varMap, varObj)
			end
	...
	x300465_TransToPosition(varMap, varPlayer)
	
end

function x300465_TransToPosition(varMap, varPlayer)
	local varCountry = GetCurCountry(varMap,varPlayer)
	if varCountry == 0 then
		LuaCallNoclosure(COMMON_CHUANSONG_NORMAL, "TransferToWorld",varMap,varPlayer,x300465_var_TransPosloulan)
	else
		StartTalkTask(varMap)
...
function x300465_ProcMapTimerTick( varMap, monsterobjid )

end


function x300465_ProcAreaLeaved( varMap, monsterobjid, varScript, varQuest )

end


function x300465_ProcEventEntry( varMap, monsterobjid )
