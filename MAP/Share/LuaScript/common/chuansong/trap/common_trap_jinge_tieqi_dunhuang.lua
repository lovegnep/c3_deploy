...
x300469_var_FileId = 300469
x300469_var_TransPosloulan=		"jinge2tieqiloulan"
x300469_var_TransPoslaiyin=		"jinge2tieqilanyin"
x300469_var_TransPoskunlun=		"jinge2tieqikunlun"
x300469_var_TransPosdunhuang=	"jinge2tieqidunhuang"



function x300469_ProcAreaEntered( varMap, varPlayer, varArea, varQuest )
	...
	if selfType == 9 then	
		...
		if busType == 1 then 
			...
			for	varI = 0, memberCount - 1 do
				...
				x300469_TransToPosition(varMap, varObj)
			end
	...
	x300469_TransToPosition(varMap, varPlayer)
	
end

function x300469_TransToPosition(varMap, varPlayer)
	local varCountry = GetCurCountry(varMap,varPlayer)
	if varCountry == 3 then
		LuaCallNoclosure(COMMON_CHUANSONG_NORMAL, "TransferToWorld",varMap,varPlayer,x300469_var_TransPosdunhuang)
	else
		StartTalkTask(varMap)
...
function x300469_ProcMapTimerTick( varMap, monsterobjid )

end


function x300469_ProcAreaLeaved( varMap, monsterobjid, varScript, varQuest )

end


function x300469_ProcEventEntry( varMap, monsterobjid )
