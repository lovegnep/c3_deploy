...
x300224_var_FileId = 300224
x300224_var_TransPosloulan  ="bianjing2gudaotianshan"
x300224_var_TransPoslaiyin  ="bianjing2gudaotianshan"
x300224_var_TransPoskunlun  ="bianjing2gudaotianshan"
x300224_var_TransPosdunhuang="bianjing2gudaotianshan"



function x300224_ProcAreaEntered( varMap, varPlayer, varArea, varQuest )
	...
	if selfType == 9 then	
		...
		if busType == 1 then 
			...
			for	varI = 0, memberCount - 1 do
				...
				x300224_TransToPosition(varMap, varObj)
			end
	...
	x300224_TransToPosition(varMap, varPlayer)
end

function x300224_TransToPosition(varMap, varPlayer)

	local guo = GetCurCountry(varMap,varPlayer)
	
	if guo == 0 then
		LuaCallNoclosure(COMMON_CHUANSONG_NORMAL, "TransferToWorld",varMap,varPlayer,x300224_var_TransPosloulan)
		
		elseif guo == 1 then
		LuaCallNoclosure(COMMON_CHUANSONG_NORMAL, "TransferToWorld",varMap,varPlayer,x300224_var_TransPoslaiyin)
		
		elseif guo == 2 then
		LuaCallNoclosure(COMMON_CHUANSONG_NORMAL, "TransferToWorld",varMap,varPlayer,x300224_var_TransPoskunlun)
		
		elseif guo == 3 then
		LuaCallNoclosure(COMMON_CHUANSONG_NORMAL, "TransferToWorld",varMap,varPlayer,x300224_var_TransPosdunhuang)
	
	end
end


function x300224_ProcMapTimerTick( varMap, monsterobjid )

end


function x300224_ProcAreaLeaved( varMap, monsterobjid, varScript, varQuest )

end


function x300224_ProcEventEntry( varMap, monsterobjid )
