...
x302623_var_ScriptId 	  = 302623
x302623_var_MissionName = "强化军粮镖车能力"
x302623_var_MissionName1 = "强化军粮镖车能力（当前为0级）"
x302623_var_MissionName2 = "强化军粮镖车能力（当前为1级）"
x302623_var_MissionName3 = "强化军粮镖车能力（当前为2级）"
x302623_var_MissionName4 = "强化军粮镖车能力（当前为3级）"
x302623_var_MissionName5 = "强化军粮镖车能力（当前为4级）"
x302623_var_MissionName6 = "强化军粮镖车能力（已为最高级）"
x302623_var_num =1


x302623_var_butonlevel ={}

x302623_CostGold		= { 400,800,1600,3200,6400}
x302623_var_Missioninfo1={
                          "\t您当前镖车没有任何护甲效果\n",
...
function x302623_ProcEnumEvent( varMap, varPlayer, targetId, MissionId)

 local BusId = GetBusId(varMap, varPlayer)
	if x302623_var_butonlevel[varPlayer] ==nil then
		 x302623_var_butonlevel[varPlayer] =1
	end
...
if 	BusId ~= -1 then
	...
	if ( level >= 50 ) then
		 if x302623_var_butonlevel[varPlayer]  ==1 then
	    TalkAppendButton( varMap, x302623_var_ScriptId, x302623_var_MissionName1, 3, 10 )
		end
	
		 if x302623_var_butonlevel[varPlayer] ==2 then
			TalkAppendButton( varMap, x302623_var_ScriptId, x302623_var_MissionName2, 3, 20 )
		 end
		 if x302623_var_butonlevel[varPlayer] ==3 then
			TalkAppendButton( varMap, x302623_var_ScriptId, x302623_var_MissionName3, 3, 30 )
		 end
		if x302623_var_butonlevel[varPlayer] ==4 then
			TalkAppendButton( varMap, x302623_var_ScriptId, x302623_var_MissionName4, 3, 40 )
		end
		if x302623_var_butonlevel[varPlayer] ==5 then
		TalkAppendButton( varMap, x302623_var_ScriptId, x302623_var_MissionName5, 3, 50 )
		end
			if x302623_var_butonlevel[varPlayer] ==6 then
		TalkAppendButton( varMap, x302623_var_ScriptId, x302623_var_MissionName6, 3, 60 )
		end
    StopTalkTask(varMap)
	end
end
...
--点击（按钮）点击该任务后执行此脚本
function x302623_ProcEventEntry( varMap, varPlayer, targetId, MissionId,seleteId )
 	if x302623_IsCanAccept( varMap, varPlayer )~=1 then
            return
   end
	...
	if x302623_var_butonlevel[varPlayer] ==nil then
	    ...
	    local BusId = GetBusId(varMap, varPlayer)
			...
			for i,itm in x302623_var_SubMissionID do
						...
						if BusId ~= -1 then
							...
							if seleteId ==10 then
							  StartTalkTask(varMap)
								...
								TalkAppendString(varMap,x302623_var_Missioninfo1[x302623_var_butonlevel[varPlayer]] )
							
							  TalkAppendString(varMap,format(x302623_var_Missioninfo2[x302623_var_butonlevel[varPlayer]],x302623_CostGold[x302623_var_butonlevel[varPlayer]]) );
								TalkAppendString(varMap,x302623_var_Missioninfo3[x302623_var_butonlevel[varPlayer]] )
								TalkAppendButton(varMap, x302623_var_ScriptId, "我要升级镖车",13,1)
								StopTalkTask(varMap)
							DeliverTalkMenu(varMap, varPlayer, targetId, x302623_var_ScriptId, x302623_var_MissionName1);
...
--								Msg2Player(varMap,varPlayer,"您已为您的镖车添加一级增益效果。",8,3)	
				        ...
				        TalkAppendString(varMap,"#Y强化军粮镖车能力" )
								...
								TalkAppendString(varMap, format(x302623_var_Missioninfo2[x302623_var_butonlevel[varPlayer]],x302623_CostGold[x302623_var_butonlevel[varPlayer]]));
								TalkAppendString(varMap, x302623_var_Missioninfo3[x302623_var_butonlevel[varPlayer]])
								TalkAppendButton(varMap, x302623_var_ScriptId, "我要升级镖车",13,2)
								StopTalkTask(varMap)
						DeliverTalkMenu(varMap, varPlayer, targetId, x302623_var_ScriptId, -1);
--							 SendSpecificImpactToUnit(varMap,varPlayer,varPlayer,BusId,31056,0)
--							 Msg2Player(varMap,varPlayer,"您已为您的镖车添加二级增益效果。",8,3)	
                ...
                StartTalkTask(varMap)
							  ...
							  TalkAppendString(varMap,x302623_var_Missioninfo1[x302623_var_butonlevel[varPlayer]] )
								...
								TalkAppendString(varMap, format(x302623_var_Missioninfo2[x302623_var_butonlevel[varPlayer]],x302623_CostGold[x302623_var_butonlevel[varPlayer]]));
								TalkAppendString(varMap, x302623_var_Missioninfo3[x302623_var_butonlevel[varPlayer]])
								TalkAppendButton(varMap, x302623_var_ScriptId, "我要升级镖车",13,3)
								StopTalkTask(varMap)
								DeliverTalkMenu(varMap, varPlayer, targetId, x302623_var_ScriptId, -1);
						  ...
						  if seleteId ==40 then
						   StartTalkTask(varMap)
							  ...
							  TalkAppendString(varMap,x302623_var_Missioninfo1[x302623_var_butonlevel[varPlayer]])
								...
								TalkAppendString(varMap, format(x302623_var_Missioninfo2[x302623_var_butonlevel[varPlayer]],x302623_CostGold[x302623_var_butonlevel[varPlayer]]));
								TalkAppendString(varMap, x302623_var_Missioninfo3[x302623_var_butonlevel[varPlayer]])
								TalkAppendButton(varMap, x302623_var_ScriptId, "我要升级镖车",13,4)
								StopTalkTask(varMap)
								DeliverTalkMenu(varMap, varPlayer, targetId, x302623_var_ScriptId, -1);
...
--							 Msg2Player(varMap,varPlayer,"您已为您的镖车添加四级增益效果。",8,3)	
							...
							if seleteId ==50 then
							 StartTalkTask(varMap)
								...
								TalkAppendString(varMap, format(x302623_var_Missioninfo2[x302623_var_butonlevel[varPlayer]],x302623_CostGold[x302623_var_butonlevel[varPlayer]]));
								TalkAppendString(varMap, x302623_var_Missioninfo3[x302623_var_butonlevel[varPlayer]])
								TalkAppendButton(varMap, x302623_var_ScriptId, "我要升级镖车",13,5)
								StopTalkTask(varMap)
							DeliverTalkMenu(varMap, varPlayer, targetId, x302623_var_ScriptId, -1);
...
--							end
		          ...
		          local BusId = GetBusId(varMap, varPlayer)
					if seleteId < 10 then				
							if GetMoney(varMap, varPlayer,2) < x302623_CostGold[seleteId] then
							StartTalkTask(varMap)
				  ...
				  if x302623_ProcAcceptCheck( varMap, varPlayer, targetId, MissionId,seleteId ) ~= 1 then
				  	return
				  end
...
function x302623_IsCanAccept( varMap, varPlayer )
...
function x302623_ProcAcceptCheck( varMap, varPlayer, targetId, MissionId,seleteId )

	local bRet = x302623_IsCanAccept( varMap, varPlayer )

	if bRet ~= 1 then
		return 0
	end     
			--现金模式
			if CostMoney( varMap, varPlayer, 2, x302623_CostGold[seleteId], 301 ) == -1 then
				StartTalkTask(varMap)
				TalkAppendString(varMap, "很抱歉，您身上携带的现金不够支付本次添加增益效果费用。");
				StopTalkTask(varMap)
				DeliverTalkTips(varMap,varPlayer)
...
function x302623_ProcAccept( varMap, varPlayer )	
...
--完成任务
--返回1代表成功，0代表交任务失败
function x302623_ProcQuestSubmit( varMap, varPlayer, targetId, selectId, MissionId )
...
--放弃
--********************************************************************
function x302623_ProcQuestAbandon( varMap, varPlayer,MissionId )  	


end


function x302623_ProcQuestAttach( varMap, varPlayer, npcId, npcGuid,misIndex, MissionId )
end

---------------------------------------------------------------------------------------------------
--任务日志刷新
---------------------------------------------------------------------------------------------------
function x302623_QuestLogRefresh( varMap, varPlayer, MissionId)
end

function x302623_ProcQuestLogRefresh( varMap, varPlayer, MissionId)
