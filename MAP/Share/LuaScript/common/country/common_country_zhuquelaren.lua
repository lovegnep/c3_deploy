x310115_var_FileId = 310115
x310115_var_QuestName="朱雀战场传送"

x310115_var_ZhuQue_Signup                  	= 100     
x310115_var_ZhuQue_WaitBattle              	= 101     
x310115_var_ZhuQue_BeginBattle             	= 102     
x310115_var_ZhuQue_EndBattle               	= 103     

function x310115_ProcEnumEvent( varMap, varPlayer, varTalknpc, varQuest )
    ...
    if nBattleStatus ~= x310115_var_ZhuQue_BeginBattle then
    	return 1
    end

    if LuaCallNoclosure(310113,"GetBattleEnterSceneFlag",varMap) ~= 1 then
       return 1
    end

	TalkAppendButton(varMap,x310115_var_FileId,x310115_var_QuestName,3);
end


function x310115_ProcEventEntry( varMap, varPlayer, varTalknpc )
    ...
    StartTalkTask( varMap )
    TalkAppendString( varMap, "确认要进入朱雀战场吗？" )
    StopTalkTask( varMap )
    DeliverTalkInfo( varMap, varPlayer, varTalknpc, x310115_var_FileId,-1 )
...
function x310115_ProcAcceptCheck( varMap, varPlayer, varTalknpc )
    return 1
end
...
function x310115_ProcAccept( varMap, varPlayer )
    ...
    GameBattleRequestEnterScene(varMap, varPlayer,0) 
end

function x310115_ProcZhuQueBattleChangeScene(varMap,varPlayer,nRetCode,newSceneID,nBattleCamp)
	...
	if nRetCode == 0 then
	    ...
	    if varMap == newSceneID then
			...
			NewWorld( varMap , varPlayer , newSceneID , PosX , PosZ,310115 )
		end
		
	else
		x310115_ProcZhuQueBattleTransError(varMap,varPlayer,nRetCode )
	end
end

function x310115_ProcZhuQueBattleTransError(varMap,varPlayer,nRetCode )
...
function x310115_ProcQuestAbandon( varMap, varPlayer, varQuest )
end




function x310115_ProcContinue( varMap, varPlayer, varTalknpc )
end




function x310115_CheckSubmit( varMap, varPlayer )
end




function x310115_ProcQuestSubmit( varMap, varPlayer, varTalknpc,varRadioSelected, varQuest )
end
