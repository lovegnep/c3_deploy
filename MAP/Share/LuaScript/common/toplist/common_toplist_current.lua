...
x310602_var_ToplistInfo       =   {
		{ClassName = "祝家庄", ClassIndex = 1,TitleClassID = 56, Desc = "祝家庄排行榜只有三番模式下才能入榜。请注意，如果副本中每环剩余怪物数过多，其成绩将不会被记入排行榜。完成此副本时间最短的前100名玩家可以登上排行榜。",    
           TitleInfo =
            {
       ...
       {ClassName = "战场等级", ClassIndex = 2,TitleClassID = 16, Desc = "战场等级排行榜记录着真正的PK强者。玩家初始战场等级为500，战场等级超过500的玩家才有资格出现在排行榜上。参与阔亦田战场每胜利一场+1，每失败一场-1。战场等级最高的前100名玩家可以登上排行榜。",   
       TitleInfo =
             {
        ...
        {ClassName = "夏王墓", ClassIndex = 3,TitleClassID = 62, Desc = "夏王墓排行榜只有三番模式下才能入榜。请注意，如果副本中每环剩余怪物数过多，其成绩将不会被记入排行榜。完成此副本时间最短的前100名玩家可以登上排行榜。",   
       TitleInfo =
             {
        ...
        {ClassName = "杀敌", ClassIndex = 4,TitleClassID = 14, Desc = "杀敌排行榜记录着异国有效杀敌数最多的勇士们。杀死不低于自己等级20级以上的异国玩家才能增加杀敌数，如果2小时内杀死同一个异国玩家超过10次，则再次杀死该玩家将不再增加杀敌数。有效杀敌数最多的前100名玩家可以登上排行榜。",  
            TitleInfo =
             {
        ...
        {ClassName = "印度河", ClassIndex = 5,TitleClassID = 64, Desc = "印度河排行榜只有三番模式下才能入榜。请注意，如果副本中每环剩余怪物数过多，其成绩将不会被记入排行榜。完成此副本时间最短的前100名玩家可以登上排行榜。",   
           TitleInfo =
            {
        ...
        {ClassName = "智力竞赛", ClassIndex = 6,TitleClassID = 36, Desc = "智力竞赛排行榜将累计一周每次智力竞赛的总分数，总分最高的前100名玩家可以登上排行榜。",   
                TitleInfo =
                 {
        ...
        {ClassName = "轮回台", ClassIndex = 7,TitleClassID = 58, Desc = "轮回台排行榜记录着守卫国家轮回台的勇士。如果完成副本时剩余怪物数过多，其成绩将不会被记入排行榜。完成此副本时间最短的前100名玩家可以登上排行榜",  
            TitleInfo =
             {
		...
		{ClassName = "屠龙", ClassIndex = 12,TitleClassID = 44, Desc = "屠龙排行榜会记录下真正的屠龙勇士，每杀死一只天龙之魂都将增加你的屠龙数，屠龙数最高的前100名玩家可以登上排行榜。",   
		...
		{ClassName = "大教堂", ClassIndex = 9,TitleClassID = 60, Desc = "大教堂排行榜只有三番模式下才能入榜。请注意，如果副本中每环剩余怪物数过多，其成绩将不会被记入排行榜。完成此副本时间最短的前100名玩家可以登上排行榜。",    
           TitleInfo =
            {
        ...
        {ClassName = "神龙宝藏", ClassIndex = 10,TitleClassID = 42, Desc = "神龙宝藏排行榜会记录下寻宝数量最多的探宝家，每使用一张神龙藏宝图挖掘宝藏都将被记录，挖宝次数最高的前100名玩家可以登上排行榜。",  		
	    ...
	    {ClassName = "囚龙岛", ClassIndex = 11,TitleClassID = 50, Desc = "囚龙岛排行榜只有三番模式下才能入榜。请注意，如果副本中每环剩余怪物数过多，其成绩将不会被记入排行榜。完成此副本时间最短的前100名玩家可以登上排行榜。", 
                TitleInfo =
                 {
		...
		{ClassName = "玫瑰", ClassIndex = 8,TitleClassID = 30, Desc = "收到过玫瑰花的男女玩家将入驻玫瑰排行榜，任何玫瑰花都会增加1点恋爱指数，恋爱指数最高的前100名玩家可以登上排行榜。",    
           TitleInfo =
            {
       ...
       {ClassName = "和氏璧", ClassIndex = 13,TitleClassID = 52, Desc = "和氏璧排行榜只有三番模式下才能入榜。请注意，如果副本中每环剩余怪物数过多，其成绩将不会被记入排行榜。完成此副本时间最短的前100名玩家可以登上排行榜。",   
           TitleInfo =
            {
       ...
       {ClassName = "小喇叭", ClassIndex = 14,TitleClassID = 46, Desc = "用小喇叭尽情的表达您的高谈阔论吧！您的声音将传遍整个世界！使用小喇叭广播次数最多的前100名玩家可以登上排行榜。", 
                TitleInfo =
                 {
       ...
       {ClassName = "赤血号", ClassIndex = 15,TitleClassID = 54, Desc = "赤血号排行榜只有三番模式下才能入榜。请注意，如果副本中每环剩余怪物数过多，其成绩将不会被记入排行榜。完成此副本时间最短的前100名的玩家可以登上排行榜。",   
        ...
        {ClassName = "放烟花", ClassIndex = 16,TitleClassID = 48, Desc = "燃放任何种类的烟花都将增长你在烟花排行榜内的分数，烂漫烟花分数最高的前100名玩家可以登上排行榜。",   
           TitleInfo =
            {
...
function x310602_ProcEnumEvent(varMap, varPlayer, varTalknpc)
	...
	TalkAppendButton(varMap,x310602_var_FileId,"本周挑战赛："..x310602_var_ToplistInfo[nTitleIndex].ClassName,0,200)
end
...
function x310602_GetTitleID(varMap, varPlayer, varTalknpc)	
	local nTitleIndex = x310602_GetTitleIndex()
    local nTitleType = x310602_var_ToplistInfo[nTitleIndex].TitleClassID
    ...
    local TitleInfo = x310602_var_ToplistInfo[nTitleIndex].TitleInfo
...
function x310602_GetCurrentTitleID()
	local nTitleIndex = x310602_GetTitleIndex()
    return x310602_var_ToplistInfo[nTitleIndex].TitleClassID
end

function x310602_ProcEventEntry(varMap, varPlayer, varTalknpc, varScript, varIndex)	
	
	    local titleIndex = x310602_GetTitleIndex()
        
        local titleID = x310602_GetTitleID(varMap, varPlayer, varTalknpc)
        ...
        local nTitleClassID = x310602_var_ToplistInfo[titleIndex].TitleClassID
	    local TitleInfo = x310602_var_ToplistInfo[titleIndex].TitleInfo
		...
		if nTitleRank <= 100 and nTitleRank > 0 then
			TitleDesc = x310602_var_ToplistInfo[titleIndex].ClassName.."挑战赛\r\n\r\n".."#W本周正在进行的是#G"..x310602_var_ToplistInfo[titleIndex].ClassName.."挑战赛#W\n于本周一0：00开幕，至本周日24：00结束。\n"..x310602_var_ToplistInfo[titleIndex].Desc.."\n你目前的排名是第#G"..nTitleRank.."#W名。\n本周比赛完成后将于下周颁奖，如果您在比赛中取得名次将会获得#G"..nExp.."#W点经验奖励，和以下额外奖励：\n\r\n"
		else
			TitleDesc = x310602_var_ToplistInfo[titleIndex].ClassName.."挑战赛\r\n\r\n".."#W本周正在进行的是#G"..x310602_var_ToplistInfo[titleIndex].ClassName.."挑战赛#W\n于本周一0：00开幕，至本周日24：00结束。\n"..x310602_var_ToplistInfo[titleIndex].Desc.."\n你目前#G还未进入该排行榜。#W\n本周比赛完成后将于下周颁奖，如果您在比赛中取得名次将会获得#G"..nExp.."#W点经验奖励，和以下额外奖励：\n\r\n"
		end
        ...
        StopTalkTask()
        DeliverTalkInfo(varMap, varPlayer, varTalknpc, x310602_var_FileId,-1);
    
	
end
function x310602_ProcAccept( varMap, varPlayer, varTalknpc, varQuest, varIndex )
    return 1
end
function x310602_ProcAcceptCheck( varMap, varPlayer, varTalknpc, varQuest, varIndex )
    return 1
end
function x310602_ProcQuestAccept( varMap, varPlayer, varTalknpc, varQuest, varIndex )
