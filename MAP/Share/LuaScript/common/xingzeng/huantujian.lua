...
-- 兑换道具需要数量
x588021_var_ExcItemNum = 500

x588021_var_QuestName = "【兑换】%s"
x588021_var_Questintro = "\t你可以用珍贵的战神王牌兑换券在我这里兑换#W坐骑图鉴，500个战神王牌兑换券就可以兑换任意一张坐骑图鉴。"
	...
	if seleteId == -1 then
		StartTalkTask(varMap)
			...
			for varI, item in x588021_var_ExcObjID  do
				TalkAppendButton( varMap, x588021_var_FileId, "【兑换】"..item.targetName, 3, varI )
			end
		StopTalkTask()
